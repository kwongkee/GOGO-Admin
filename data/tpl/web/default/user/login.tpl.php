...
<div class="login">
	...
	<div class="center-block footer" role="footer">
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerright'])) { ?><a href="http://www.gogo198.com">关于購購</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerright'];?><?php  } ?> &nbsp; &nbsp; <?php  if(!empty($_W['setting']['copyright']['statcode'])) { ?><?php  echo $_W['setting']['copyright']['statcode'];?><?php  } ?>
		</div>
		<div class="text-center">
			<?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by <a href="http://www.gogo198.com"><b>購購</b></a> v<?php echo IMS_VERSION;?> &copy; 2014-2016 <a href="http://www.gogo198.com">www.gogo198.com</a><?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?>
		</div>
		<div class="text-center">
		    <a href="https://shop.gogo198.cn/attachment/购购网用户条款与隐私协议.pdf">会员协议</a>
		</div>
	</div>
</div>
<script>
