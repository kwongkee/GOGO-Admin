...
<!--		<h5 class="page-header">云服务</h5>
		<div class="clearfix">
			...
			<a href="http://www.gogo198.com/app_index.html" class="tile tile-2x img-rounded" target="_blank">
				<i class="fa fa-print"></i>
				<span>应用商城</span>
			</a>
			<a href="http://www.gogo198.com/home.php?mod=spacecp&ac=credit&op=buy" class="tile tile-2x img-rounded" target="_blank">
		...
		<div class="clearfix">
			...
			<a href="<?php  echo url('system/keyword');?>" class="tile tile-2x img-rounded">
				<i class="fa fa-book"></i>
				<span>关键字管理</span>
			</a>
		</div>
