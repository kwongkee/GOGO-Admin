...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-6">
        ...
        <label class="radio-inline"><input type="radio" name="isverify" value="2" <?php  if($item['isverify'] == 2) { ?>checked="true"<?php  } ?>   /> 支持</label> <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12 chks">
        ...
        <?php  } else { ?>
        <div class='form-control-static'>
            <?php  if(is_array($stores)) { foreach($stores as $store) { ?> <?php  echo $store['storename'];?>; <?php  } } ?>
        </div>
        <?php  } ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-6">
        ...
        <label class="radio-inline"><input type="radio" name="balance_with_store" value="0" <?php  if(empty($item['balance_with_store']) || $item['balance_with_store']  == 0) { ?>checked="true"<?php  } ?> onclick="$('#goods_balance').show()"  /> 否</label> <?php  } else { ?>
        <div class='form-control-static'>
...
<div class="form-group" id="goods_balance" <?php  if($item[ 'balance_with_store']==1 ) { ?> style="display:none;" <?php  } ?>>
    ...
    <div class="col-sm-6 col-xs-6">
        <?php if( ce('shop.goods' ,$item) ) { ?>
        <input type="text" class="form-control" name="goods_balance" value="<?php  echo $item['goods_balance'];?>" /> <?php  } else { ?>
        <div class='form-control-static'>
...
<script language='javascript'>
    function search_stores() {
        ...
        $.get('{php echo $this->createPluginWebUrl('
            verify / store ',array('
            op '=>'
            query '))}', {
