  ...
  <table class='table' style='float:left;border:1px solid #ccc;margin-top:5px;margin-bottom:0px;table-layout: fixed;'>
                <tr >
                    <td colspan='8'  style='border-bottom:1px solid #ccc;background:#f8f8f8;' >
                        ...
                        <?php  } else if($item['ordersn_sn']!=$item['ordersn_general'] ) { ?>
                        <b>支付单号:</b>  <?php  echo $item['ordersn_general'];?>
                        <?php  } ?>
                        <!--xj 171019 显示订单号-->
...
<!--                    </td>-->
                    <td style='border-left:none;text-align:left;/*width:150px*/'>原价: <?php  echo number_format( $g['price'],2)?> <br />应付: <?php  echo number_format($g['realprice'],2)?>
                        <br/>数量: <?php  echo $g['total'];?>
                    </td>
