            ...
            <form action="./index.php" method="get" class="form-horizontal" plugins="form">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">回复状态</label>
                       <div class="col-xs-12 col-sm-8 col-lg-9">
    ...
    <div class='panel panel-default'>
        ...
        <?php if(cv('shop.comment.add')) { ?>
            <div class='panel-footer'>
                          <a class='btn btn-primary' href="<?php  echo $this->createWebUrl('shop/comment',array('op'=>'add'))?>"><i class='fa fa-plus'></i> 添加评价</a>
          </div>
        <?php  } ?>
    </div>
</form>
