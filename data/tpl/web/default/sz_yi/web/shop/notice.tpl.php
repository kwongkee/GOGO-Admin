            ...
            <tbody>
                ...
                <tr>
                    <td colspan='6'>
                          ...
                          <a class='btn btn-primary' href="<?php  echo $this->createWebUrl('shop/notice',array('op'=>'post'))?>"><i class='fa fa-plus'></i> 添加公告</a>
                          <?php  } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="input-group ">
                            <input class="form-control" type="text" data-id="PAL-00010" placeholder="请填写指向的链接 (请以http://开头, 不填则不显示)" value="<?php  echo $notice['link'];?>" name="link">
