...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <input type="number" name="displayorder" id="displayorder" class="form-control" value="<?php  echo $item['displayorder'];?>" />
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class="input-group form-group">
            ...
            <input type="number" name="marketprice" id="marketprice" class="form-control" value="<?php  echo $item['marketprice'];?>" />
    ...
    <?php if( ce('shop.goods' ,$item) ) { ?>
        <div class="input-group form-group">
            ...
            <input type="number" name="productprice" id="productprice" class="form-control" value="<?php  echo $item['productprice'];?>" />
            <span class="input-group-addon">元</span>
        </div>
           <?php  } else { ?>
        ...
        <div class="input-group form-group">
            ...
            <input type="number" name="costprice" id="costprice" class="form-control" value="<?php  echo $item['costprice'];?>" />
            <span class="input-group-addon">元</span>
        </div>
           <?php  } else { ?>
        ...
        <?php  } ?>
          <div class="input-group form-group">
              ...
              <input type="number" name="bonusmoney" class="form-control" value="<?php  echo $item['bonusmoney'];?>" />
              <span class="input-group-addon">元</span>
          </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-12">
        <?php if( ce('shop.goods' ,$item) ) { ?>
        <div class="input-group">
            <input type="number" name="weight" id="weight" class="form-control" value="<?php  echo $item['weight'];?>" />
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-12">
             <?php if( ce('shop.goods' ,$item) ) { ?>
        <div class="input-group">
            <input type="number" name="total" id="total" class="form-control" value="<?php  echo $item['total'];?>" />
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-12">
               <?php if( ce('shop.goods' ,$item) ) { ?>
        <div class="input-group">
            <input type="number" name="maxbuy" id="maxbuy" class="form-control" value="<?php  echo $item['maxbuy'];?>" />
            <span class="input-group-addon">件</span>
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-12">
            <?php if( ce('shop.goods' ,$item) ) { ?>
        <div class="input-group">
            <input type="number" name="usermaxbuy" class="form-control" value="<?php  echo $item['usermaxbuy'];?>" />
            <span class="input-group-addon">件</span>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-12">
              <?php if( ce('shop.goods' ,$item) ) { ?>
        <div class="input-group">
            <input type="number" name="sales" id="sales" class="form-control" value="<?php  echo $item['sales'];?>" />
            <span class="input-group-addon">件</span>
        </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6 col-xs-12">
            <?php if( ce('shop.goods' ,$item) ) { ?>
        <div class="input-group">
            <input type="number" name="credit" id="credit" class="form-control" value="<?php  echo $item['credit'];?>" />
