            ...
            <div class="panel-body">
                ...
                <div class="col-sm-9 col-xs-12">
                    <p class='form-control-static'><a href='javascript:;' title='点击复制连接' id='cp'>
                           <?php  if(empty($parent)) { ?>
                           <?php  echo $this->createMobileUrl('shop/list',array('pcate1'=>$item['id']))?>
                           <?php  } else { ?>
                               <?php  if(empty($parent1)) { ?>
                                 <?php  echo $this->createMobileUrl('shop/list',array('ccate1'=>$item['id']))?>
                               <?php  } else { ?>
                                 <?php  echo $this->createMobileUrl('shop/list',array('tcate1'=>$item['id']))?>
                               <?php  } ?>
                           <?php  } ?>
                        </a>
                    </p>
                        ...
                        <div class="dd" id="div_nestable">
                                ...
                                <li class="dd-item" data-id="<?php  echo $row['id'];?>">
                                    ...
                                    <div class="dd-handle"  style='width:100%;'>
                                        ...
                                        <span class="pull-right">
                                            <?php if(cv('shop.category.add')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createWebUrl('shop/category2', array('parentid' => $row['id'], 'op' => 'post'))?>" title='添加子分类' ><i class="fa fa-plus"></i></a><?php  } ?>
                                            <?php if(cv('shop.category.edit|shop.category.view')) { ?>
                                             <a class='btn btn-default btn-sm' href="<?php  echo $this->createWebUrl('shop/category2', array('id' => $row['id'], 'op' => 'post'))?>" title="<?php if(cv('shop.category.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>" ><i class="fa fa-edit"></i></a>
                                            <?php  } ?>
                                            <?php if(cv('shop.category.delete')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createWebUrl('shop/category2', array('id' => $row['id'], 'op' => 'delete'))?>" title='删除' onclick="return confirm('确认删除此分类吗？');return false;"><i class="fa fa-remove"></i></a><?php  } ?>
                                        </span>
                                    </div>
                                            ...
                                            <div class="dd-handle">
                                                ...
                                                <span class="pull-right">
                                                    <?php  if(intval($shopset['catlevel'])==3) { ?>
                                                     <?php if(cv('shop.category.add')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createWebUrl('shop/category2', array('parentid' => $child['id'], 'op' => 'post'))?>" title='添加子分类' ><i class="fa fa-plus"></i></a><?php  } ?>
                                                     <?php  } ?>
                                                      <?php if(cv('shop.category.edit|shop.category.view')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createWebUrl('shop/category2', array('id' => $child['id'], 'op' => 'post'))?>" title="<?php if(cv('shop.category.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>" ><i class="fa fa-edit"></i></a><?php  } ?>
                                                      <?php if(cv('shop.category.delete')) { ?> <a class='btn btn-default btn-sm' href="<?php  echo $this->createWebUrl('shop/category2', array('id' => $child['id'], 'op' => 'delete'))?>" title='删除' onclick="return confirm('确认删除此分类吗？');return false;"><i class="fa fa-remove"></i></a><?php  } ?>
                                                </span>
                                            </div>
                                                    ...
                                                    <ol class="dd-list"  style='width:100%;'>
                                                        ...
                                                        <li class="dd-item" data-id="<?php  echo $third['id'];?>">
                                                            <div class="dd-handle">
                                                                ...
                                                                <span class="pull-right">
                                                                        <?php if(cv('shop.category.edit|shop.category.view')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createWebUrl('shop/category2', array('id' => $third['id'], 'op' => 'post'))?>" title="<?php if(cv('shop.category.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>" ><i class="fa fa-edit"></i></a><?php  } ?>
                                                                      <?php if(cv('shop.category.delete')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createWebUrl('shop/category2', array('id' => $third['id'], 'op' => 'delete'))?>" title='删除' onclick="return confirm('确认删除此分类吗？');return false;"><i class="fa fa-remove"></i></a><?php  } ?>
                                                                </span>
                                                            </div>
                                                        </li>
                                                        <?php  } } ?>
                            ...
                            <table class='table'>
                                ...
                                <td>
                                    ...
                                    <a href="<?php  echo $this->createWebUrl('shop/category2',array('op' => 'post'))?>" class="btn btn-primary"><i class="fa fa-plus"></i> 添加新分类</a>
                                    <?php  } ?>
                                    <?php if(cv('shop.category.edit')) { ?>
                                    <input id="save_category2" type="button" class="btn btn-default" value="保存分类修改">
                                    <?php  } ?>
                                    <input type="hidden" name="token" value="<?php  echo $_W['token'];?>" />
