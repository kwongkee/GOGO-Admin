    ...
    <div class="panel-body table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <?php $dispath_name = $item['supplier_uid']==0 ? "(总店)" : "(". $item['supplier_name'] .")";?>
                <tr>
                    ...
                    <td><?php  echo $item['dispatchname'];?><?php  echo $dispath_name;?></td>
                ...
                <div class="form-group dispatch0" style='display:none'>
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <select name='express' class="form-control input-medium">
                            ...
                            <option value="ztky" data-name="中铁快运">中铁快运</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style='height:280px;;' > 
                ...
                <div class='province'>
                    ...
                    <ul>
                        <!-- han 20170926 s-->
                            <?php  if(in_array($value['@attributes']['name'],array('北京','天津','重庆','上海'))) { ?>
                                <?php  if(is_array($value['city']['county'])) { foreach($value['city']['county'] as $c) { ?>
                                <li>
