...
<div class="right-titpos">
	<ul class="add-snav">
		<li class="active"><a href="#">PC端设置</a></li>
	</ul>
</div>
<!-- 新增加右侧顶部三级菜单结束 -->
    ...
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" >
        ...
        <div class="panel panel-default">
            ...
            <div class='panel-body'>  
                ...
                <?php  if($set['shop']['style_pc']=='default_new') { ?>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">拼图广告</label>
                    <div class="col-sm-9">
                        <div class="input-group"  style="width: 99%;float:left;margin-right:1%">
                            <?php  echo tpl_ueditor('pcset[pcadv]',$set['shop']['pcadv'])?>
                        </div>
                    </div>
                </div>
                <?php  } ?>
            ...
            <div class='panel-body'>
                 <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <label class="radio-inline">
                            <input type="radio" name="pcset[isreferral]" value="0" <?php  if($set['shop']['isreferral']==0) { ?>checked<?php  } ?> /> 禁用
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="pcset[isreferral]" value="1" <?php  if($set['shop']['isreferral']==1) { ?>checked<?php  } ?> /> 启用
                        </label>
                    </div> 
                </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <label class="radio-inline">
                            <input type="radio" name="pcset[paytype]" value="0" <?php  if(empty($set['shop']['paytype'])) { ?>checked<?php  } ?> /> 余额
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="pcset[paytype]" value="1" <?php  if($set['shop']['paytype']==1) { ?>checked<?php  } ?> /> 微信钱包
                        </label>
		...
		-->
            ...
            <!-- 判断调用pc模板是否为default_drug 显示该模板下内容--> 
           <?php  if($set['shop']['style_pc']=='default_drug') { ?>
            <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">底部自定义链接</label>
                    <div class="col-sm-9 col-xs-12">
                    <textarea  style="width:1170px;height:600px;" name="pcset[footercontent]"><?php  echo $set['shop']['footercontent'];?></textarea>
                    </div>
            </div> 
            <?php  } ?>     
