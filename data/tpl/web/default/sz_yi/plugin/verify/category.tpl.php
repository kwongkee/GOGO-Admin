        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="col-sm-9 col-xs-12">
                    <p class='form-control-static'><a href='javascript:;' title='点击复制连接' id='cp'>
                           <?php  if(empty($parent)) { ?>
                           <?php  echo $this->createPluginMobileUrl('verify/store_list',array('pcate'=>$item['id']))?>
                           <?php  } else { ?>
                               <?php  if(empty($parent1)) { ?>
                                 <?php  echo $this->createPluginMobileUrl('verify/store_list',array('ccate'=>$item['id']))?>
                               <?php  } else { ?>
                                 <?php  echo $this->createPluginMobileUrl('verify/store_list',array('tcate'=>$item['id']))?>
                               <?php  } ?>
                           <?php  } ?>
                        </a>
                    </p>
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <?php  } ?>
                       <input type="button" name="back" onclick='history.back()' <?php if(cv('verify.store.add|verify.store.edit')) { ?>style='margin-left:10px;'<?php  } ?> value="返回列表" class="btn btn-default col-lg-1" />
                    </div>
            </div>
                        ...
                        <div class="dd" id="div_nestable">
                                ...
                                <li class="dd-item" data-id="<?php  echo $row['id'];?>">
                                    ...
                                    <div class="dd-handle"  style='width:100%;'>
                                        ...
                                        <span class="pull-right">
                                            <?php if(cv('verify.store.add')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createPluginWebUrl('verify/category', array('parentid' => $row['id'], 'op' => 'post'))?>" title='添加子分类' ><i class="fa fa-plus"></i></a><?php  } ?>
                                            <?php if(cv('verify.store.edit|verify.store.view')) { ?>
                                             <a class='btn btn-default btn-sm' href="<?php  echo $this->createPluginWebUrl('verify/category', array('id' => $row['id'], 'op' => 'post'))?>" title="<?php if(cv('verify.store.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>" ><i class="fa fa-edit"></i></a>
                                            <?php  } ?>
                                            <?php if(cv('verify.store.delete')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createPluginWebUrl('verify/category', array('id' => $row['id'], 'op' => 'delete'))?>" title='删除' onclick="return confirm('确认删除此分类吗？');return false;"><i class="fa fa-remove"></i></a><?php  } ?>
                                        </span>
                                    </div>
                                            ...
                                            <div class="dd-handle">
                                                ...
                                                <span class="pull-right">
                                                    <?php  if(intval($shopset['catlevel'])==3) { ?>
                                                     <?php if(cv('verify.store.add')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createPluginWebUrl('verify/category', array('parentid' => $child['id'], 'op' => 'post'))?>" title='添加子分类' ><i class="fa fa-plus"></i></a><?php  } ?>
                                                     <?php  } ?>
                                                      <?php if(cv('verify.store.edit|verify.store.view')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createPluginWebUrl('verify/category', array('id' => $child['id'], 'op' => 'post'))?>" title="<?php if(cv('verify.store.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>" ><i class="fa fa-edit"></i></a><?php  } ?>
                                                      <?php if(cv('verify.store.delete')) { ?> <a class='btn btn-default btn-sm' href="<?php  echo $this->createPluginWebUrl('verify/category', array('id' => $child['id'], 'op' => 'delete'))?>" title='删除' onclick="return confirm('确认删除此分类吗？');return false;"><i class="fa fa-remove"></i></a><?php  } ?>
                                                </span>
                                            </div>
                                                    ...
                                                    <ol class="dd-list"  style='width:100%;'>
                                                        ...
                                                        <li class="dd-item" data-id="<?php  echo $third['id'];?>">
                                                            <div class="dd-handle">
                                                                ...
                                                                <span class="pull-right">
                                                                        <?php if(cv('verify.store.edit|verify.store.view')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createPluginWebUrl('verify/category', array('id' => $third['id'], 'op' => 'post'))?>" title="<?php if(cv('verify.store.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>" ><i class="fa fa-edit"></i></a><?php  } ?>
                                                                      <?php if(cv('verify.store.delete')) { ?><a class='btn btn-default btn-sm' href="<?php  echo $this->createPluginWebUrl('verify/category', array('id' => $third['id'], 'op' => 'delete'))?>" title='删除' onclick="return confirm('确认删除此分类吗？');return false;"><i class="fa fa-remove"></i></a><?php  } ?>
                                                                </span>
                                                            </div>
                                                        </li>
                                                        <?php  } } ?>
                            ...
                            <table class='table'>
                                ...
                                <td>
                                    ...
                                    <a href="<?php  echo $this->createPluginWebUrl('verify/category',array('op' => 'post'))?>" class="btn btn-primary"><i class="fa fa-plus"></i> 添加新分类</a>
                                    <?php  } ?>
                                    <?php if(cv('verify.store.edit')) { ?>
