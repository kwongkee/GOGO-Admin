            ...
            <div class="panel-body">
                    <div class="form-group">
                       ...
                       <div class="col-sm-9 col-xs-12">
                           ...
                           <span class='help-block'>开启<?php  echo SZ_YI_INTEGRAL?>抵扣, 商品最多抵扣的数目需要在商品【营销设置】中单独设置</span>
                           <?php  } else { ?>
                   ...
                   <div class="form-group">
                       <label class="col-xs-12 col-sm-3 col-md-2 control-label"><?php  echo SZ_YI_INTEGRAL?>抵扣比例</label>
                       <div class="col-sm-5">
                                <?php if(cv('sale.deduct.save')) { ?> 
                           <div class='input-group'>
                                   <input type="hidden" name="data[credit]" value="1" class="form-control" />
                                   <span class='input-group-addon'>1个<?php  echo SZ_YI_INTEGRAL?> 抵扣</span>
                                   <input type="text" name="data[money]"  value="<?php  echo $set['money'];?>" class="form-control" />
                                   <span class='input-group-addon'>元</span>
                           </div>
                           <span class='help-block'><?php  echo SZ_YI_INTEGRAL?>抵扣比例设置</span>
                             <?php  } else { ?>
                           <div class='form-control-static'><?php  echo $set['credit'];?><?php  echo SZ_YI_INTEGRAL?> 抵扣 <?php  echo $set['money'];?> 元</div>
                           <?php  } ?>
                       </div>
                   </div>
                 <div class="form-group">
