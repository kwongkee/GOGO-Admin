...
<ul class="nav nav-tabs">
    ...
    <!--xj屏蔽 <?php if(cv('commission.apply.view3')) { ?><li <?php  if($_GPC['method']=='apply' && ($_GPC['status']==4 || $apply['status']==4)) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createPluginWebUrl('commission/apply',array('status'=>4))?>">已到款提现</a></li><?php  } ?> -->
