...
<div class="w1200 m0a">
    ...
    <div class="rightlist">
            ...
            <div class='panel-body'>
                <table class="table" >
                    ...
                    <tr>
                        ...
                        <th style="width:14%; text-align: center;">是否默认</th>
                    ...
                    <tr menuid="<?php  echo $menu['id'];?>">
                        <td style="width:10%; text-align: center;"><?php  echo $menu['id'];?></td>
                        <td><?php  echo $menu['menuname'];?></td>
                        <td style="width:14%; text-align:  center;"><?php  echo date('Y-m-d H:i',$menu['createtime'])?></td>
                        <td style="width:14%; text-align:  center;" data-id="<?php  echo $menu['id'];?>">
        ...
        <div class='panel panel-default' ng-app="FoxEditor" style="background: #f2f2f2">
            ...
            <div class='panel-body' ng-controller="FoxController" style="padding:8px">
                <div class="fe" style="margin-left:0">
                    ...
                    <div class="fe-panel" style="width:538px !important">
        ...
        <script type="text/javascript">
            ...
            $(function(){
                ...
                $(".fe-save-submit3").click(function() {
                    location.href = "<?php  echo $this->createPluginWebUrl('designer/menu')?>";
                });
                            ...
                            {update: function(e, ui){
                                ...
                                $(this).find(".fe-panel-editor-input1").each(function(){
                                    for(var i in menusArray){
                                        if($(this).val() == menusArray[i].title){
                                ...
                                for(var i in menusArray){
                                    ...
                                    for(var j in tmpArray){
                                        for(var k in tmpSubMenus){
                                            if(tmpArray[j] == tmpSubMenus[k].title){
