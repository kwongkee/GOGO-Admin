                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-sm-8 col-lg-9 col-xs-12">
                            <select name='agentuid' class='form-control'>
                                <option value="<?php  echo $_W['uid'];?>">总店</option>
                                <?php  if(is_array($agents)) { foreach($agents as $row) { ?>
                                <option value='<?php  echo $row['uid'];?>' <?php  if($item['agentuid']==$row['uid']) { ?>selected<?php  } ?>><?php  echo $row['username'];?></option>
                                <?php  } } ?>
                            </select>
                        </div>
                    </div> -->
                ...
                <div class="panel-body table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><span class="label label-danger"><?php  echo $item['name'];?></span></td>
