...
<div class="page-heading"> <h2>1688助手</h2> </div>
    ...
    function fetch_next() {
        var postdata =  {
            ...
            local: $("#savelocal").val()
               ...
               <?php  } ?>
        $.post("<?php  echo $this->createPluginWebUrl('taobao/one688/fetch')?>",
               postdata,
        function (data) {
