		...
		<div class="panel panel-default">
						...
						<?php  if($cate==1) { ?>
							<div class="input-group" style="margin-top: 10px; width: 300px;">
								...
								<select id="express" name="express" class="form-control">
									...
									<option <?php  if($item['express']=='ztky') { ?>selected=""<?php  } ?> data-name="中铁快运" value="ztky">中铁快运</option>
									...
									<option <?php  if($item['express']=='annengwuliu') { ?>selected=""<?php  } ?> data-name="安能物流" value="annengwuliu">安能物流</option>
								</select>
							</div>
						<?php  } ?>
				</div>
			...
			<div class="panel" style="height: auto; overflow: hidden; background: none;">
				...
				<div class="edit-right">
					<div id="container" style="/*width:<?php  if(!empty($item['width'])) { ?><?php  echo $item['width'];?><?php  } else { ?>142<?php  } ?>mm;*/ height: <?php  if(!empty($item['height'])) { ?><?php  echo $item['height'];?><?php  } else { ?>150<?php  } ?>mm;">
