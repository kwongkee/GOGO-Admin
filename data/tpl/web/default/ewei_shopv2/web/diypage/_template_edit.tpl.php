...
<script type="text/html" id="tpl_edit_notice">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <div class="input-group input-group-sm">
                <input class="form-control input-sm diy-bind color" data-bind-child="style" data-bind="bordercolor" value="<%style.bordercolor||'#e2e2e2'%>" type="color" />
                <span class="input-group-addon btn btn-default" onclick="$(this).prev().val('#e2e2e2').trigger('propertychange')">重置</span>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="input-group " style="margin-top:.5em;">
                ...
                <span class="close" style="position:absolute; top: -10px; right: -14px;" title="移除图片" onclick="$('#iconsrc').val('').trigger('change');$(this).prev().attr('src', '')">×</span>
            </div>
        </div>
    </div>
...
<script type="text/html" id="tpl_edit_merchgroup">
    ...
    <%if params.openlocation==1%>
        <div class="form-group">
            <div class="col-sm-2 control-label">商户排序</div>
            <div class="col-sm-10">
...
<script type="text/html" id="tpl_edit_fixedsearch">
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">搜索框透明度</div>
        <div class="col-sm-10">
            <div class="form-group">
                <div class="slider col-sm-8 " data-value="<%style.opacityinput%>" data-min="0" data-max="10" data-decimal="10"></div>
                <div class="col-sm-4 control-labe count"><span><%style.opacityinput%></span>(最大是1)</div>
                <input class="diy-bind input" data-bind-child="style" data-bind="opacityinput" value="<%style.opacityinput%>" type="hidden" />
            </div>
        </div>
    </div>
    <div class="line"></div>
...
<script type="text/html" id="tpl_edit_tabbar">
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">超出滚动数</div>
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="scrollnum" value="3" class="diy-bind" data-bind-child="style" data-bind="scrollnum" <%if style.scrollnum==3||!style.scrollnum%>checked="checked"<%/if%> > 超出3个滚动</label>
            <label class="radio-inline"><input type="radio" name="scrollnum" value="4" class="diy-bind" data-bind-child="style" data-bind="scrollnum" <%if style.scrollnum==4%>checked="checked"<%/if%>> 超出4个滚动</label>
        </div>
    </div>
