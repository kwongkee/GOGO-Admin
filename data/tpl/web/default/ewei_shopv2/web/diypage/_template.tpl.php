<?php defined('IN_IA') or exit('Access Denied');?><script type="text/html" id="tpl_show_notice">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-notice" style="background: <%style.background%>; border-color: <%style.bordercolor%>;">
            <%if params.iconurl%>
        ...
        <div class="diy-fixedsearch">
            ...
            <div class="inner">
                ...
                <div class="center <%params.searchstyle%>">
                    <input value="<%params.placeholder%>" style="opacity: <%style.opacityinput%>; background: <%style.searchbackground%>; color: <%style.searchtextcolor%>;" />
                </div>
