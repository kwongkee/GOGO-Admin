...
<table class="table table-hover table-responsive">
    ...
    <tr rel="pop" data-title="ID: <?php  echo $row['id'];?> ">
        ...
        <td><?php  echo $row['status0'];?><br/><?php  echo $row['status3'];?></td>
        <td><?php  if(empty($row['jointime'])) { ?>-<?php  } else { ?><?php  echo date('Y-m-d',$row['jointime'])?> <?php  echo date('H:i',$row['jointime'])?><?php  } ?><br/>
            <?php  if(empty($row['accounttime'])) { ?>-<?php  } else { ?><?php  echo date('Y-m-d',$row['accounttime'])?><?php  } ?></td>
        <td>
            <?php  if($row['status']==1) { ?>
