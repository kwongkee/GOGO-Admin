...
<div class='fui-page  fui-page-current'>
		...
		<div class="fui-cell-group fui-cell-click">
			...
			<div id="order" style="display: none;">
				...
				<div id="yifuOrder1" style="display: none;">
					<a class="fui-cell" href="<?php  echo mobileUrl('parking/invoicelist/park_order')?>">
						<div class="fui-cell-icon"><i class="icon icon"></i></div>
						<div class="fui-cell-text"><p>停车订单</p></div>
						<!--<div class="fui-cell-remark"></div>-->
					</a>

					<a class="fui-cell" href="<?php  echo mobileUrl('order',array('status'=>1))?>">
						<div class="fui-cell-icon"><i class="icon icon"></i></div>
				...
				<div id="weifuOrder1" style="display: none;">
					<a class="fui-cell" href="<?php  echo mobileUrl('parking/invoicelist/park_Norder')?>">
						<div class="fui-cell-icon"><i class="icon"></i></div>
						<div class="fui-cell-text"><p>停车订单</p></div>
						<!--<div class="fui-cell-remark"></div>-->
					</a>
					
					<a class="fui-cell" href="<?php  echo mobileUrl('parking/invoicelist/shop_Norder')?>">
						<div class="fui-cell-icon"><i class="icon icon"></i></div>
						<div class="fui-cell-text"><p>电商订单</p></div>
						<!--<div class="fui-cell-remark"></div>-->
					</a>
	...
	<div class="fui-cell-group fui-cell-click" style="display:none;" id="ren">
		...
		<a class="fui-cell external" href="<?php  echo mobileUrl('parking/cards')?>" data-nocache="true">
			<div class="fui-cell-icon"><i class="icon icon-countdown"></i></div>
		...
		<div id="invoice1" style="display: none;">
			...
			<div id="park_invoice1" style="display: none;">
				...
				<div class="fui-cell" id="kp">
					<div class="fui-cell-icon"><i class="icon icon"></i></div>
					<div class="fui-cell-text"><p>开具</p></div>
				</div>
				
				<div id="kp1" style="display: none;">
					<a class="fui-cell" href="<?php  echo mobileUrl('parking/invoicelist/park')?>">
						<div class="fui-cell-icon"><i class="icon icon"></i></div>
						<div class="fui-cell-text"><p>停车订单开票</p></div>
					</a>
					
					<a class="fui-cell" href="<?php  echo mobileUrl('parking/invoicelist/shop')?>">
						<div class="fui-cell-icon"><i class="icon icon"></i></div>
						<div class="fui-cell-text"><p>电商订单开票</p></div>
					</a>
					
				</div>
				
				
				<div class="fui-cell" id="cx">
					<div class="fui-cell-icon"><i class="icon icon"></i></div>
					<div class="fui-cell-text"><p>查询</p></div>
				</div>
				<div id="cx1" style="display: none;">
					<a class="fui-cell" href="<?php  echo mobileUrl('parking/invoicelist/history')?>">
						<div class="fui-cell-icon"><i class="icon icon"></i></div>
						<div class="fui-cell-text"><p>停车开票历史</p></div>
					</a>
					
					<a class="fui-cell" href="<?php  echo mobileUrl('parking/invoicelist/shop_history')?>">
						<div class="fui-cell-icon"><i class="icon icon"></i></div>
						<div class="fui-cell-text"><p>电商开票历史</p></div>
					</a>
