        ...
        <li>
            <a href="<?php  echo $this->createMobileUrl('shop/detail',array('id' => $item['id']))?>">                                  
                ...
                <div class="item_price clearfix">
                    <span class="price"><?php  echo $item['marketprice'];?></span> <span class="sales"><?php  if($_W['uniacid'] == 18) { ?>Sell<?php  } else { ?>已售<?php  } ?>:<em><?php  echo $item['sales'];?></em></span>
                </div>
...
<div class="listl_rc">
    ...
    <?php  } else { ?>
        <span class="divide">&gt;</span>
        <a class="c" href="<?php  echo $this->createMobileUrl('shop/list')?>"><?php  if($_W['uniacid'] == 18) { ?>All Products<?php  } else { ?>全部商品<?php  } ?></a>
    <?php  } ?>
    <?php  if($ccatename) { ?>
        <span class="divide">&gt;</span>
...
<span style="color:#666;font-size:12px;"><?php  echo $goods['title'];?></span>
    ...
    <dl class="odd">
        <dt><?php  if($_W['uniacid'] == 18) { ?>Price<?php  } else { ?>价格<?php  } ?>：</dt>
        <dd>
            <a href="javascript:;" ><?php  if($_W['uniacid'] == 18) { ?>All<?php  } else { ?>全部<?php  } ?></a>
                ...
                <a href="<?php  echo $this->createMobileUrl('shop/list',array('pcate'=>$_GPC['pcate'],'ccate'=>$_GPC['ccate'],'tcate'=>$_GPC['tcate'],'minprice' => '0','maxprice' => '100'))?>" >
                        <?php  if($_W['uniacid'] == 18) { ?>¥0 - 100<?php  } else { ?>0 - 100元<?php  } ?>
                </a>
                ...
                <a href="<?php  echo $this->createMobileUrl('shop/list',array('pcate'=>$_GPC['pcate'],'ccate'=>$_GPC['ccate'],'tcate'=>$_GPC['tcate'],'minprice' => '100','maxprice' => '200'))?>" >
                        <?php  if($_W['uniacid'] == 18) { ?>¥100 - 200<?php  } else { ?>100 - 200元<?php  } ?>
                </a>
    ...
    <?php  } ?>
        ...
        <script id='tpl_filter' type='text/html'> 
            ...
            <div class="rankitem">
                    ...
                    <span style="float:left;padding:9px 0px 0px 15px;;"><?php  if($_W['uniacid'] == 18) { ?>Sort<?php  } else { ?>排序<?php  } ?>：</span>                  
                    <span class="orderCell" data-order='sales' data-by='desc'>
                        <a class="item itemDefault" href="javascript:void(0)"><span><?php  if($_W['uniacid'] == 18) { ?>Sales from high to low<?php  } else { ?>销量从高到低<?php  } ?></span></a>
                    </span>
                    <span class="orderCell" data-order='marketprice' data-by='asc'>
                        <a class="item itemDefault" href="javascript:void(0)"><span><?php  if($_W['uniacid'] == 18) { ?>Price from low to high<?php  } else { ?>价格从低到高<?php  } ?></span></a>
                    </span>
                    <span class="orderCell" data-order='marketprice' data-by='desc'>
                        <a class="item itemDefault" href="javascript:void(0)"><span><?php  if($_W['uniacid'] == 18) { ?>Price from high to low<?php  } else { ?>价格从高到低<?php  } ?></span></a>
                    </span>
                    <span class="orderCell" data-order='score' data-by='asc'>
                        <a class="item itemDefault" href="javascript:void(0)"><span><?php  if($_W['uniacid'] == 18) { ?>Evaluation from high to low<?php  } else { ?>评价从高到低<?php  } ?></span></a>
                    </span>
                </div>
            </script>
                ...
                <ul>
                    ...
                    <li>
                        <div class="bor-sort">
                            ...
                            <img src="<?php  echo $g['thumb'];?>" onerror="javascript:this.src='/attachment/images/3/default.png'" style="width: 238px;height: 238px;"></a>
                            <a class="sort-tit" href="#"><?php  echo $g['title'];?></a>
                            <p><em>￥<?php  echo $g['marketprice'];?></em><i><?php  if($_W['uniacid'] == 18) { ?>Total sales<?php  } else { ?>总销量<?php  } ?><b><?php  echo $g['sales'];?></b></i>
...
<script id='tpl_empty' type='text/html'>
    <div class="list_no">
        ...
        <br>
        <span style="line-height:18px; font-size:16px;"><?php  if($_W['uniacid'] == 18) { ?>No related products<?php  } else { ?>暂时没有相关商品<?php  } ?></span>
        <br><?php  if($_W['uniacid'] == 18) { ?>Master quickly go find me something else<?php  } else { ?>主人快去给我找点其他东西吧<?php  } ?>
    </div>
    <div class="list_no_menu">
        <div class="list_no_nav" onclick="location.href='<?php  echo $this->createMobileUrl('shop/list')?>'"><?php  if($_W['uniacid'] == 18) { ?>Look at other<?php  } else { ?>看看其他的<?php  } ?></div>
    </div>
</script>
