...
<style type="text/css">
    ...
    #express_qrcode img{z-index: 999999;}

    .detail_topbar {height:68px; background:#5f6e8b; padding:15px;}
    ...
    .detail_good {height:auto;padding:0 10px;background:#fff;  margin-top:16px; border-top:1px solid #eaeaea;}
    .detail_good .ico {height:6px; width:10px; line-height:36px; float:left; text-align:center;}
    .detail_good .shop {height:36px; width:100%; padding-left:26px; border-bottom:1px solid #eaeaea; line-height:30px; font-size:14px; color:#333;}
    .detail_good .good {height:70px; width:100%; padding:10px 0px; border-bottom:1px solid #eaeaea;}
    ...
    .detail_express .ico {height:6px; width:10px; line-height:36px; float:left; text-align:center;}
    .detail_express .title {height:36px; width:100%; padding-left:26px; border-bottom:1px solid #eaeaea; line-height:30px; font-size:14px; color:#333;}
...
<div class='detail_express'>
    <div class="ico"><i class="fa fa-truck" style="color:#666; font-size:20px;"></i></div>
    <div class="title">扫码查看物流</div>
    <div class='content' id='express_qrcode'>
...
<script type="text/javascript">
    ...
    require(['tpl', 'core'], function(tpl, core) {
        ...
        core.json('order/express',{id:'<?php  echo $_GPC['id'];?>'},function(json){
                ...
                //  },true,false,true);
                var url = "https://m.kuaidi100.com/result.jsp?nu="+order.expresssn;
                var qrcode = new QRCode(document.getElementById("express_qrcode"), {
                    width : 200,
                    height : 180
                });
                qrcode.makeCode(url);
