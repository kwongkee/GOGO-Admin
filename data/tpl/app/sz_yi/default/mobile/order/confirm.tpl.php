...
var fromcart = 0;
    require(['tpl', 'core'], function(tpl, core) {
        core.json('order/confirm', {id:'<?php  echo intval($_GPC['id'])?>', optionid:'<?php  echo intval($_GPC['optionid'])?>', total:'<?php  echo intval($_GPC['total'])?>',cartids:"<?php  echo $_GPC['cartids'];?>",ischannelpay:"<?php  echo $_GPC['ischannelpay'];?>",ischannelpick:"<?php  echo $_GPC['ischannelpick'];?>",isyunbipay:"<?php  echo $_GPC['isyunbipay'];?>",cartids:"<?php  echo $_GPC['cartids'];?>"}, function(json){
       ...
       if($('#sel-provance').val()=='请选择省份'){
        ...
        $('.paysub').click(function() {
          ...
          $(this).attr('submitting', '1').html('提交中...'); 
          	//数据提交到mobile/order/confirm/options = create && ispost 1445行
