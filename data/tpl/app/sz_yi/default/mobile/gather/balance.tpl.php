...
<div id="container" style="padding-bottom:15px;">
    ...
    <div class="page_topbar" style="display: flex;align-items: center;">
        <div class="title" style="margin-left:110px;">支付<?php  echo $balance_order['ordersn'];?></div>
    </div>
    <div class="info_main">
        <div class="line"><div class="title">交易单号</div><div class='info'><div class='inner'><?php  echo $balance_order['ordersn'];?></div></div></div>
        <div class="line"><div class="title">交易类型</div><div class='info'><div class='inner'>费用预付</div></div></div>
        <div class="line"><div class="title">交易名称</div><div class='info'><div class='inner'>余额充值</div></div></div>
    </div>

    <div class="info_main">
        <div class="line"><div class="title">交易总额</div><div class='info'><div class='inner'>CNY <?php  echo $balance_list['recharge_money'];?></div></div></div>
        <div class="line"><div class="title">实付金额</div><div class='info'><div class='inner'>CNY <?php  echo $balance_list['recharge_money'];?></div></div></div>
        <div class="line"><div class="title">支付状态</div><div class='info'><div class='inner' style="color:#ff2222;"><?php  echo $status;?></div></div></div>
    </div>
    <div class="info_main">
    ...
    <div class="info_main">
        <div class="line"><div class="title">生成时间</div><div class='info'><div class='inner'><?php  echo date('Y-m-d H:i:s',$balance_order['createtime'])?></div></div></div>
        <?php  if($pay_status==1) { ?>
        <div class="line"><div class="title">支付时间</div><div class='info'><div class='inner'><?php  echo date('Y-m-d H:i:s',$balance_order['paytime'])?></div></div></div>
        <?php  } ?>
    </div>
    <?php  if($balance_order['status']==0 && $_GPC['isadmin']!=1) { ?>
...
<div class="complete_baseinfo" style="display:none;"></div>
...
<script language="javascript">
    require(['tpl', 'core'], function(tpl, core) {
        ...
        //获取支付信息和提交支付
        core.json('gather/balance',{orderid:"<?php  echo $balance_order['id'];?>",openid:"<?php  echo $openid;?>",op:'pay'},function(json){
            ...
            if(result.tgwechat.success){
                $('.order_sub12').click(function() {
                    core.json('gather/balance', {op: 'tgpay',type: 'tgwechat', orderid:"<?php  echo $balance_order['id'];?>",openid:"<?php  echo $openid;?>"}, function (rjson) {
            ...
            if(result.tgalipay.success){
                ...
                $('.order_sub13').click(function(){
                    ...
                    location.href = core.getUrl('gather/balance',{op: 'tgpay',type: 'tgalipay', orderid:"<?php  echo $balance_order['id'];?>",openid:"<?php  echo $openid;?>"});
                })
            }
        },true);
