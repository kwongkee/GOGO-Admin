...
<style>
    ...
    /*.layui-table-grid-down {width: 30px;}*/
    .layui-table-cell, .layui-table-tool-panel li{text-overflow:unset;}
    /*.layui-table-grid-down .layui-icon {margin: -12px 0 0 -8px;}*/
</style>
<div class="page_head">
    <div class="left">
        <div class="back"></div>
                ...
                <div class="layui-card-body">
                    <div class="main-table-reload-btn" style="margin-bottom: 10px;">
                        ...
                        <div class="layui-inline">
                            <input class="layui-input" placeholder="要搜索的人员名称"  id="keywords" autocomplete="off">
                        </div>
...
<script>
    $(function() {
        ...
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
            ...
            table.render({
                elem: '#mainTable'
                ,url: "./index.php?i=3&c=entry&do=approval&p=send&m=sz_yi&op=my_copy&pa=1"
                ,cellMinWidth: 200
                ,cols: [[
                    ...
                    ,{align:'center',  title: '操作',fixed:'right',width:100, templet: function(d){
                        return [
                            ...
                            '<a  class="layui-btn layui-btn-xs layui-btn-success" onclick="openWindow('+"'"+ d.id +"'" +','+"2"+');">下载审批</a>',
                            '<a  class="layui-btn layui-btn-xs layui-btn-danger" onclick="openWindow('+"'"+ d.id +"'" +','+"3"+');">数据关联</a>',
    ...
    function openWindow(id,typ,name='')
    {
        ...
        if(typ==1){
            ...
            layer.open({
                ...
                title:'查看详情['+name+']',
                area:['100%','100%'],
                content:'./index.php?i=3&c=entry&do=approval&m=sz_yi&p=send&op=approval_detail&is_copy=1&id='+id
            });
        }else if(typ==2){
            //下载审批
            $.ajax({
