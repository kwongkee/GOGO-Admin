...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=send&op=my_initiate" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="我的发起">我的发起</span>
        </a>

        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=send&op=my_approval" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="我的审批">我的审批</span>
        </a>

        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=send&op=my_copy" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="我的抄送">我的抄送</span>
        </a>
    </div>
</div>
