...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=send&op=initiate_approval" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="发起">发起</span>
        </a>

        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=send&op=manage" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="管理">管理</span>
        </a>
    </div>
</div>
