...
<div class="container container-fill">
    <div class="home-container clearfix">
        <a href="javascript:history.back(-1);" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="">返回上一页</span>
        </a>

        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=index&op=role_list&func=1" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="角色列表">角色列表</span>
        </a>

        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=index&op=event_list&func=2" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="事项列表">事项列表</span>
        </a>

        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=index&op=person_list&func=3" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="人员列表">人员列表</span>
        </a>
    </div>
</div>
