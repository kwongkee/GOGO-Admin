            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-header">
                        <div class="layui-btn layui-btn-normal layui-btn-sm" onclick="openWindow(0,2)">新增事项</div>
                    ...
                    <div class="layui-card-body">
                        <div class="main-table-reload-btn" style="margin-bottom: 10px;">
                            ...
                            <div class="layui-inline">
                                <input class="layui-input" placeholder="要搜索的事项名称"  id="keywords" autocomplete="off">
                            </div>
...
<script>
    $(function() {
        ...
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
            ...
            table.render({
                elem: '#mainTable'
                ,url: "./index.php?i=3&c=entry&do=approval&p=index&m=sz_yi&op=event_list&pa=1"
                ,cellMinWidth: 200
                ,cols: [[
    ...
    function openWindow(id,typ)
    {
        ...
        if(typ==1){
            //编辑角色
            window.location.href="./index.php?i=3&c=entry&do=approval&p=index&m=sz_yi&op=save_event&id="+id;
        }else if(typ==2){
            //新增角色
            window.location.href="./index.php?i=3&c=entry&do=approval&p=index&m=sz_yi&op=save_event&id="+id;
        }else if(typ==3){
            ...
            layer.confirm('确认删除吗？',function(){
                $.ajax({
                    url:"./index.php?i=3&c=entry&do=approval&p=index&m=sz_yi&op=del_event",
                    method:'post',
                    data:{'id':id},
                    dataType:'JSON',
