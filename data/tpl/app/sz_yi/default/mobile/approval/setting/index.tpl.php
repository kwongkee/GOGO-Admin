...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=index&op=person_set" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="人员配置">人员配置</span>
        </a>

        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=index&op=approval_set&func=4" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="审批配置">审批配置</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=approval&m=sz_yi&p=index&op=diyForm_set&func=5" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="表单配置">表单配置</span>
        </a>
    </div>
</div>
