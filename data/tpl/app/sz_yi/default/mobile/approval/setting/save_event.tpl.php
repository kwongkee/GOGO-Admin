                ...
                <form class="layui-form" action="" lay-filter="component-form-demo1">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block layui-select-fscon">
                            <input type="text" name="name" lay-verify="required" placeholder="请输入事项名称" autocomplete="off" class="layui-input" value="<?php  echo $info['name'];?>">
                        </div>
                    </div>
...
<?php  } else { ?>
    <p style="text-align:center;font-size:16px;margin-top:10px;">抱歉！您没有权限修改该事项。</p>
<?php  } ?>
<script>
    layui.use(['layer', 'form', 'table', 'upload', 'laydate','jquery'], function () {
        ...
        form.on('submit(component-form-demo1)', function(data){
            $.ajax({
                url:"./index.php?i=3&c=entry&do=approval&p=index&m=sz_yi&op=save_event",
                method:'post',
                data:data.field,
                dataType:'JSON',
