    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">中国海关检验检疫代码表</div>
...
<script>
    $(function() {
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
            ...
            table.render({
                elem: '#mainTable'
                ,url: "<?php  echo $this->createMobileUrl('hscode/index');?>&op=inspection_quarantine_list&pa=1"
                ,cellMinWidth: 200
                ,cols: [[
                    {field:'code_value', width: '50%', title: '代码'}
                    ,{field:'code_name', width: '50%', title: '名称'}
                ]]
                ,page: false
            });
