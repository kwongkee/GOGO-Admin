    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">hsCode列表</div>
                <div class="layui-card-body" style="padding:0;">
                    ...
                    <p style="color:red;">*查找不到时，可以输入空格分词查询（如：隔热 垫）</p>
...
<script>
    $(function() {
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
            ...
            table.render({
                elem: '#mainTable'
                ,url: "<?php  echo $this->createMobileUrl('hscode/index');?>&op=display&pa=1"
                ,cellMinWidth: 200
                ,cols: [[
                    {field:'two', width: 80, title: '第二位'}
                    ,{field:'four', width: 80, title: '第四位'}
                    ,{field:'five', width: 80, title: '第五位'}
                    ,{field:'six', width: 80, title: '第六位'}
                    ,{field:'seven', width: 80, title: '第七位'}
                    ,{field:'eight', width: 80, title: '第八位'}
                    ,{field:'hscode', title: 'hs编码'}
                    ,{field:'name', title: '中文名称'}
                    ,{align:'center', fixed:'right',width:80, title: '操作', templet: function(d){
                            return [
                                '<a onclick="openWindow('+ "'"+d.hscode+"的信息'" +',' + "'"+ d.id +"'" +','+"1"+ ');" class="layui-btn layui-btn-normal layui-btn-xs">查看详情</a>',
                            ].join('');
                        } }
                ]]
                ,page: true
