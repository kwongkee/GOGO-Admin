...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=tax_list&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="税费列表">税费列表</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=tax_declare&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="税费申报">税费申报</span>
        </a>
    </div>
</div>
