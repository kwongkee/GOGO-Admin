...
<div id="container">
    <div class="info_main table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        <select name="opera_queren" id="opera_queren" onchange="opera_queren(this,<?php  echo $val['id'];?>,<?php  echo $list['id'];?>)">
                            ...
                            <option value="1" data-typ="<?php  echo $val['type'];?>">查看</option>
                            <?php  if($val['status']>=7) { ?>
                            <option value="2" data-typ="<?php  echo $val['type'];?>">下载</option>
                            <?php  } ?>
        ...
        <div class="see" onClick="submit(<?php  echo $list['id'];?>)" style="width: 30%;margin: 10px auto;">凭证签收(0)</div>
        <?php  } ?>
    </div>
</div>
...
<script language="javascript">
    ...
    function cancel(thi){
        ...
        window.ids='';
        window.times=0;
        $(thi).parent().parent().parent().find('.caozuo').find('.opera2').removeClass('noAdd').text('添加凭证');
    }
    ...
    function sign(thi) {
        ...
        $(thi).parent().parent().parent().siblings().find('.caozuo').find('.opera2').removeClass('noAdd').text('添加凭证').hide();
    }
            ...
            success:function(json) {
                if(json.status==1){
                    ...
                    if(typ==2){
                        ...
                        // window.history.go(-1);
                        window.location.reload();
                        // window.location.href='./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=voucher_sign';
                    }
                }
            }
        });
