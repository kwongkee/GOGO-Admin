...
<style type="text/css">
    ...
    .home-container .box-item{float:left;display:block;text-decoration:none;outline:none;width:4em;height:6em;margin:.1em;background:rgba(0, 0, 0, 0.3);text-align:center;color:#fff;}
...
<div class="container container-fill">
    <div class="home-container clearfix">
        <!--商户管理-->
        <a href="./index.php?i=3&c=entry&do=account&p=index&m=sz_yi" class="box-item" style="position:relative;margin-right:15px;">
            <div style="background: #1EA01E;padding: 5px 0;" title="我要汇总">我要汇总</div>
        </a>
        <a href="javascript:notBook();" class="box-item" style="position:relative;">
            <div style="background: #f60a0a;padding: 5px 0;" title="记账端">不用记账</div>
        </a>
    </div>
</div>
        ...
        if(confirm('确认贵司上月无需记账吗？')){
           $.ajax({
               ...
               success: function (json) {
                ...
                //   setTimeout(function(){
                //       window.location.href="./index.php?i=3&c=entry&do=account&p=register&m=sz_yi&op=reconciliation_lastMonth_info&ids="+json.result.ids;
                //   },2000);
               }
           }); 
        }
