...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <!--voucherSummary-->
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=selectMonth&opera=1" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="凭证汇总">凭证汇总</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=person_reg" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="人员增减">人员增减</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=basic_set" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="配置管理">配置管理</span>
        </a>
    </div>
</div>
