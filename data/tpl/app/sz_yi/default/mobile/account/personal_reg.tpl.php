...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=person_operation&type=1" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="社保增减">社保增减</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=person_operation&type=2" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="个税增减">个税增减</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=opera_manage" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="增减管理">增减管理</span>
        </a>
    </div>
</div>
