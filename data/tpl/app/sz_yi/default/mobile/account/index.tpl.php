...
<div class="container container-fill">
    <div class="home-container clearfix">
        <!--商户管理-->
        <?php  if($auth['user']==1) { ?>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="企业端">企业端</span>
        </a>
        <?php  } ?>
        <?php  if($auth['account']==1) { ?>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=selectMonth&opera=3" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="记账端">记账端</span>
        </a>
        <?php  } ?>
        <?php  if($auth['manager']==1) { ?>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=manage&op=menu" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="管理端">管理端</span>
        </a>
        <?php  } ?>
    </div>
</div>
