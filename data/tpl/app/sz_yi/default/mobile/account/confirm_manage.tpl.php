...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=manage&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="汇总确认">汇总确认</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=manage&op=reconciliation&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="对账确认">对账确认</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=manage&op=taxes&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="税费确认">税费确认</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=manage&op=personal_addReduce&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="增减确认">增减确认</span>
        </a>
    </div>
</div>
