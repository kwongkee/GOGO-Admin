...
onchange="this.selectedIndex=this.defaultIndex;">
                    ...
                    <option value="1" <?php echo $data['money_status']=='1'?'selected':''?>>已开票，应收款</option>
                    <option value="2" <?php echo $data['money_status']=='2'?'selected':''?>>已开票，未收款</option>
                    <option value="3" <?php echo $data['money_status']=='3'?'selected':''?>>未开票，预收款</option>
                </select>
            </div></div>
        </div>
        <!--开票状态-->
        <div class="line bill_box <?php echo $data['money_status']=='1'?'bill_box_disp':'bill_box_nodisp'?>">
...
onchange="this.selectedIndex=this.defaultIndex;">
        ...
        <!--凭证信息-->
        <?php  if((($data['money_status']==1 && $data['bill_status']==2) || ($data['money_status']==1 && $data['bill_status']==1) || ($data['money_status']==2))) { ?>
        <div class="voucher_info">
            ...
            <div class="line">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type_radio" data-val="1"><i class="fa <?php echo $data['voucher_type']==1?'fa-check-circle-o':'fa-circle-o';?>"></i>销售发票(记账联)</span>
                        <span class="voucher_type_radio" data-val="2" style="margin-left:5px;"><i class="fa <?php echo $data['voucher_type']==2?'fa-check-circle-o':'fa-circle-o';?>"></i>收款凭证</span>
            ...
            <div class="line voucher_type1_2  <?php echo $data['voucher_type1']==2?'voucher_type_show':'voucher_type_hide';?>">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type1_2_radio" data-val="1"><i class="fa <?php echo $data['voucher_type1_2_radio']==1?'fa-check-circle-o':'fa-circle-o';?>"></i>增值税普通发票(折叠票)</span>
                        <span class="voucher_type1_2_radio" data-val="2" style="margin-left:5px;margin-right: 10px;"><i class="fa  <?php echo $data['voucher_type1_2_radio']==2?'fa-check-circle-o':'fa-circle-o';?>"></i>增值税普通发票(卷式)</span>
            ...
            <div class="line voucher_type2 <?php echo $data['voucher_type']==2?'voucher_type_show':'voucher_type_hide';?>">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type2_radio" data-val="1"><i class="fa <?php echo $data['voucher_type2']==1?'fa-check-circle-o':'fa-circle-o';?>"></i>银行入账证明</span>
                        <span class="voucher_type2_radio" data-val="2" style="margin-left:5px;"><i class="fa  <?php echo $data['voucher_type2']==2?'fa-check-circle-o':'fa-circle-o';?>"></i>现金收款凭证</span>
            ...
            <div class="line voucher_type2_1 <?php echo $data['voucher_type2']==1?'voucher_type_show':'voucher_type_hide';?>">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type2_1_radio" data-val="1"><i class="fa <?php echo $data['voucher_type2_1']==1?'fa-check-circle-o':'fa-circle-o';?>"></i>支票进账单</span>
                        <span class="voucher_type2_1_radio" data-val="2" style="margin-left:5px;"><i class="fa <?php echo $data['voucher_type2_1']==2?'fa-check-circle-o':'fa-circle-o';?>"></i>托收收账单</span>
                        <span class="voucher_type2_1_radio" data-val="3" style="margin-left:5px;"><i class="fa <?php echo $data['voucher_type2_1']==3?'fa-check-circle-o':'fa-circle-o';?>"></i>多余款通知单</span>
            ...
            <div class="line voucher_type2_2 <?php echo $data['voucher_type2']==2?'voucher_type_show':'voucher_type_hide';?>">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type2_2_radio" data-val="1"><i class="fa <?php echo $data['voucher_type2_2']==1?'fa-check-circle-o':'fa-circle-o';?>"></i>收据存根联</span>
        ...
        <?php  } ?>
         ...
         <!--收款信息-->
        <?php  if((($data['money_status']==1 && $data['bill_status']==1) || ($data['money_status']==1 && $data['bill_status']==2) || ($data['money_status']==3))) { ?>
        <div class="collect_info">
            <!--收款金额-->
            <div class="line"><div class="title">收款金额</div><div class='info'><div class='inner'>
                <div class="disf" style="align-items: center;">
                    ...
                    <input type="number" id='trade_price2' placeholder="收款金额"  style="width:32%;" value="<?php  echo $data['trade_price2'];?>" onkeyup="value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')"/>
                    <input type="number" id='trade_rate' class="<?php echo $data['currency2']!=142?'trade_rate_block':'trade_rate_hide'?>" placeholder="交易汇率"  style="width:32%;" value="<?php  echo $data['trade_rate'];?>"/>
                </div>
            </div></div></div>
            <!--收款方式-->
            <div class="line">
                ...
                <div class="inner">
                    <span class="collect_type" data-val="1"><i class="fa <?php echo $data['collect_type']==1?'fa-check-circle-o':'fa-circle-o';?>"></i> 现金收款</span>&nbsp;&nbsp;
                    <span class="collect_type" data-val="2"><i class="fa <?php echo $data['collect_type']==2?'fa-check-circle-o':'fa-circle-o';?>"></i> 转账收款</span>
                    <input type="text" name="collect_type" id="collect_type" value="<?php  echo $data['collect_type'];?>" style="display: none;">
                </div>
            </div>
            <!--转账收款-->
            <div class="line transfer_collect <?php echo $data['collect_type']==2?'voucher_type_show':'voucher_type_hide';?>"><div class="title" style="background:#fff;z-index:99;">转账收款</div><div class="info"><div class="inner" style="z-index:98;">
            ...
            <!--<div class="account_receipt" style="display:none;">-->
                <!--<div class="line"><div class="title">入账回单</div><div class='info'><div class='inner'>-->
    ...
    <!---->
        ...
        <div class="line" style="height:70px;line-height: 0;">
            ...
            <div class="info"><div class="inner">
                <textarea name="diy_remark" id="diy_remark" cols="40" rows="4" style="width:290px;" placeholder="请输入此凭证备注信息"><?php  echo $data['diy_remark'];?></textarea>
            </div></div>
        </div>
...
<script language="javascript">
    ...
    require(['tpl', 'core'], function(tpl, core) {
        ...
        $('#voucher_date').change(function(){
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: {'op': 'collect_reg', 'add_reg': 4, 'date': select_date2},
        ...
        $('.voucher_type_radio').click(function() {
            ...
            if(val==1){
                ...
                $('.voucher_type1').hide();$('.voucher_type1_2').hide();$('.voucher_type2').hide();$('.voucher_type2_1').hide();$('.voucher_type2_2').hide();
            }
        });
        ...
        $('.voucher_type2_radio').click(function() {
            ...
            if(val==1){
                ...
                $('.voucher_type2_1').hide();
                $('.voucher_type2_2').show();
            }
        });
        ...
        $('.transfer_collect_type').click(function(){
            ...
            if(val==1){
                ...
                $('.account_receipt').show();
                $('.account_receipt').find('.title').text('入账回单');
                ...
                $('.collect_account').show();
                $('.account_receipt').show();
                $('.account_receipt').find('.title').text('收款截图');
    ...
    $(function(){
        $('.info_sub').click(function(){
            ...
            //凭证信息
            if(money_status==2 || (money_status==1 && bill_status==2)) {
                if( $('#voucher_type').isEmpty()){
                    alert('请选择凭证类别!');
                    return;
                }
            ...
            if(money_status==1 || money_status==3){
            ...
            //收款信息
            if((money_status==1 && bill_status==1) || (money_status==1 && bill_status==2) || money_status==3){
