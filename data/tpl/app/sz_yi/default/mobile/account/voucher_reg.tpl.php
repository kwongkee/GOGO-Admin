...
<style type="text/css">
    ...
    .page_head{width:100%;background:rgba(255,255,255,0.5);margin-bottom:5px;box-shadow:0 0 4px #ddd;padding:10px 0 10px;}
...
<!--    <div class="left">-->
<!--        <div class="back"></div>-->
<!--        <div style="font-size:15px;padding-top:2px;"></div>-->
<!--    </div>-->
<!--</div>-->
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=special_purpose_voucher" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="专用记账凭证">专用记账凭证</span>
        </a>
        <!--<a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=general_purpose_voucher" class="box-item" style="width:120px !important;position:relative;">-->
        <!--    <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>-->
        <!--    <span style="color:;" title="通用记账凭证">通用记账凭证</span>-->
        <!--</a>-->
    </div>
</div>
