...
<script language="javascript">
    ...
    $(function(){
        if("<?php  echo $opera;?>"==2){
            changeDom(2,"<?php  echo $date;?>");
        }else{
            changeDom(1,"<?php  echo $date;?>");
        }
    ...
    function changeDom(index,date){
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: {'op': 'opera_manage', 'type': index + 1,'id':<?php  echo $id;?>,'date':date},
                        ...
                        if(dat!=''){
                            ...
                            for (var i=0;i<dat.length;i++){
                                html += '                <tr>\n' +
                                    ...
                                    '                    <td>\n' +
                                    '                       <div class="see" onclick=\'down('+dat[i].id+')\' id="down'+dat[i].id+'" style="background:#125526;padding:4px 10px;">下载</div>\n'+
                                    '                    </td>\n' +
                                    '                </tr>\n';
                            }
                            html += '                </tbody>\n' +
