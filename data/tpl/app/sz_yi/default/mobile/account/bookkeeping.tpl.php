...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="javascript:history.back(-1);" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="专用记账凭证">返回上一页</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=voucher_sign&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="凭证签收">凭证签收</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=voucher_keep&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="凭证记账">凭证记账</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=reconciliation&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="对账管理">对账管理</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=tax_manage&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="税费管理">税费管理</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=socialTax_info&date=<?php  echo $_GPC['date'];?>" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="人员增减">人员增减</span>
        </a>
    </div>
</div>
