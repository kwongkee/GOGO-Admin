...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=manage&op=accounting_config" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="记账配置">记账配置</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=register&op=selectMonth&opera=2" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="确认管理">确认管理</span>
        </a>
    </div>
</div>
