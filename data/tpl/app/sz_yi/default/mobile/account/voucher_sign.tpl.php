    ...
    <div class="info_main table-responsive">
        ...
        <table class="table table-striped" style="table-layout:fixed;word-break: break-all;text-align: center;">
            ...
            <?php  if($val['is_show']==1) { ?>
                <tr>
                    <td style="white-space: pre-line;"><?php  echo $val['batch_num'];?></td>
                    <td><?php  echo $val['user_name'];?></td>
                    <td><?php  echo $val['createtime'];?></td>
                    <td><a class="see" style="width:fit-content;margin:0 auto;" href="./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=voucher_signAll&batch_id=<?php  echo $val['id'];?>">查看</a></td>
                </tr>
            <?php  } ?>
            <?php  } } ?>
        </table>
...
<script language="javascript">
        ...
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
            ...
            laydate.render({
                ...
                ,done: function(value, date, endDate){
                    window.location.replace('./index.php?i=3&c=entry&do=account&m=sz_yi&p=bookkeeping&op=voucher_sign&date='+value);
                }
            });
        });
    ...
    function add_voucher(t,id,batch_id){
        ...
        $(t).parent().parent().parent().parent().siblings().find('.submit').html('凭证签收('+times+')');
    }
