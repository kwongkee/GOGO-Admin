...
<style type="text/css">
    ...
    /*select{height: -webkit-fill-available;width:fit-content;padding:0;height:38px;}*/
    ...
    <div class="info_main">
        ...
        <div class="line">
            ...
            <div class="info"><div class="inner">
                <select name="money_status" id="money_status">
                    ...
                    <option value="1">已开票，应收款</option>
                    <option value="2">已开票，未收款</option>
                    <option value="3">未开票，预收款</option>
                </select>
            </div></div>
        </div>
        <!--开票状态-->
        ...
        <div class="voucher_info" style="display:none;">
            ...
            <div class="line">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type_radio" data-val="1"><i class="fa fa-circle-o"></i>销售发票(记账联)</span>
                        <span class="voucher_type_radio" data-val="2" style="margin-left:5px;"><i class="fa fa-circle-o"></i>收款凭证</span>
            ...
            <div class="line voucher_type2" style="display:none;">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type2_radio" data-val="1"><i class="fa fa-circle-o"></i>银行入账证明</span>
                        <span class="voucher_type2_radio" data-val="2" style="margin-left:5px;"><i class="fa fa-circle-o"></i>现金收款凭证</span>
            ...
            <div class="line voucher_type2_1" style="display:none;">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type2_1_radio" data-val="1"><i class="fa fa-circle-o"></i>支票进账单</span>
                        <span class="voucher_type2_1_radio" data-val="2" style="margin-left:5px;"><i class="fa fa-circle-o"></i>托收收账单</span>
                        <span class="voucher_type2_1_radio" data-val="3" style="margin-left:5px;"><i class="fa fa-circle-o"></i>多余款通知单</span>
            ...
            <div class="line voucher_type2_2" style="display:none;">
                ...
                <div class='info'>
                    <div class='inner'>
                        <span class="voucher_type2_2_radio" data-val="1"><i class="fa fa-circle-o"></i>收据存根联</span>
        ...
        <div class="collect_info" style="display:none;">
            <div class="line"><div class="title">收款金额</div><div class='info'><div class='inner'>
                <div class="disf" style="align-items: center;">
                    ...
                    <input type="number" id='trade_price2' placeholder="收款金额"  style="width:32%;" value="" onkeyup="value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')"/>
            ...
            <div class="line">
                ...
                <div class="inner">
                    <span class="collect_type" data-val="1"><i class="fa fa-circle-o"></i> 现金收款</span>&nbsp;&nbsp;
                    <span class="collect_type" data-val="2"><i class="fa fa-circle-o"></i> 转账收款</span>
                    <input type="text" name="collect_type" id="collect_type" value="" style="display: none;">
                </div>
            </div>
            <!--转账收款-->
            <div class="line transfer_collect" style="display: none;"><div class="title" style="background:#fff;z-index:99;">转账收款</div><div class="info"><div class="inner" style="z-index:98;">
...
<!--<script type="text/javascript" src="https://www.jq22.com/demo/jQueryQrcode201709202327/llqrcode.js"></script>-->
<!--<script type="text/javascript" src="https://www.jq22.com/demo/jQueryQrcode201709202327/analyticCode.js"></script>-->
<!--<script type="text/javascript" src="../addons/sz_yi/static/js/dist/area/jquery.qrcode.js"></script>-->
...
<script language="javascript">
    ...
    require(['tpl', 'core'], function(tpl, core) {
        ...
        $("#submit_method").change(function() {
            ...
            // console.log(voucher_type.isEmpty());
            if(!$('#voucher_type').isEmpty()){
                if(selected==1){
                    //快递提交
    ...
    $(function(){
        $('.info_sub').click(function(){
            ...
            if(money_status==1 && bill_status==1){
                //选择早前凭证
                if($('#voucher_id').isEmpty()){
                    alert('请选择“已开票，未收款”列表中的凭证！');return;
                }
            }
    ...
    function sel(id){
        ...
        $.ajax({
            ...
            type: 'POST',
            dataType: 'json',
            data: {'op': 'collect_reg', 'add_reg': 3, 'typ': 1,'id':id},
            success: function (json) {
                var data = json.result.data;
