        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <div class="layui-btn layui-btn-normal layui-btn-sm" onclick="openWindow()">分类列表</div>
                </div>
                <?php  } ?>
                <div class="layui-card-body" style="padding:20px 0 0;">
                    <?php  if(is_array($list)) { foreach($list as $val) { ?>
                        <a href="./index.php?i=3&c=entry&do=policy&p=column&m=sz_yi&cate_id=<?php  echo $val['id'];?>">
                            <div class="box">
                                <div class="box2">
...
<script>
    ...
    {
        //分类列表
        window.location.href="<?php  echo $this->createMobileUrl('policy/index');?>&op=category_list";
    }
</script>
