            ...
            <form class="layui-form" action="" lay-filter="component-form-demo1">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="category_name" lay-verify="required" placeholder="请输入分类名称" autocomplete="off" class="layui-input" value="<?php  echo $info['category_name'];?>">
                    </div>
                </div>
...
<script>
    layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
        ...
        form.on('submit(component-form-demo1)', function(data){
            $.ajax({
                url:"./index.php?i=3&c=entry&do=policy&p=manage&m=sz_yi&op=save_category",
                method:'post',
                data:data.field,
                dataType:'JSON',
