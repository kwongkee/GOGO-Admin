...
<!--百度富文本-->
<script type="text/javascript" src="https://shop.gogo198.cn/foll/public/static/cklein/plugins/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="https://shop.gogo198.cn/foll/public/static/cklein/plugins/ueditor/ueditor.all.min.js"> </script>
<script type="text/javascript" src="https://shop.gogo198.cn/foll/public/static/cklein/plugins/ueditor/lang/zh-cn/zh-cn.js"></script>
...
<style>
    ...
    .layui-input, .layui-textarea{width:98%;}
</style>
<div class="page_head">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 0px;">
            <form class="layui-form" action="" lay-filter="component-form-demo1">
                ...
                <input type="number" name="cate_id" value="<?php  echo $cate_id;?>" style="display:none;">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="issuing_authority" lay-verify="required" placeholder="请输入发文机关" autocomplete="off" class="layui-input" value="<?php  echo $info['issuing_authority'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">文号</label>
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="document_number" lay-verify="required" placeholder="请输入文号" autocomplete="off" class="layui-input" value="<?php  echo $info['document_number'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">新闻标题</label>
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="name" lay-verify="required" placeholder="请输入新闻标题" autocomplete="off" class="layui-input" value="<?php  echo $info['name'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">发布日期</label>
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="release_date" id="release_date" lay-verify="required" placeholder="请输入发布日期" autocomplete="off" class="layui-input" value="<?php  echo $info['release_date'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">生效日期</label>
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="effective_date" id="effective_date" placeholder="请输入生效日期" autocomplete="off" class="layui-input" value="<?php  echo $info['effective_date'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">效力</label>
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="effect" placeholder="请输入效力" autocomplete="off" class="layui-input" value="<?php  echo $info['effect'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">效力说明</label>
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="effect_statement" placeholder="请输入效力说明" autocomplete="off" class="layui-input" value="<?php  echo $info['effect_statement'];?>">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="link" lay-verify="required" placeholder="请输入原文链接" autocomplete="off" class="layui-input" value="<?php  echo $info['link'];?>">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <textarea name="desc" id="desc" rows="5" placeholder="请输入新闻描述" class="layui-textarea"><?php  echo $info['desc'];?></textarea>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <div class="layui-upload" style="text-align:left;">
                            ...
                            <div type="button" class="layui-btn pic_file_blur" style="background:#999;display:none;">上传封面图</div>
                            <blockquote class="layui-elem-quote layui-quote-nm yulan" style="margin-top: 10px;">
                                ...
                                <div class="layui-upload-list" id="pic_list-upload-list">
                                    ...
                                    <div style="display: inline-block;margin-top:10px;overflow:visible;">
                                        <img onclick="seePic(this);" src="<?php  echo $info['avatar'];?>" class="layui-upload-img"  style="width:30px;">
                                        ...
                                        <input type="hidden" name="pic_file[0]" value="<?php  echo $info['avatar'];?>">
                                    </div>
                                    <?php  } ?>
                                </div>
                            </blockquote>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <script id="content" type="text/plain" style="width:98%;height:200px;">
                            <?php  if(isset($info['content'])) { ?>
                            <?php  echo stripslashes(htmlspecialchars_decode($info['content']));?>
                            <?php  } ?>
                        </script>
                        ...
                        <div class="layui-form-item layui-layout-admin">
                            ...
                            layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
                                ...
                                var ue = UE.getEditor('content', {
                                    ...
                                    serverUrl: 'https://shop.gogo198.cn/foll/public/static/cklein/plugins/ueditor/php/controller.php'
                                });
                                ...
                                form.on('submit(component-form-demo1)', function(data){
                                    if(data.field['editorValue']==''){
                                        layer.msg('请输入内容！');
                                        return false;
                                    }
                                    layer.load();
                                    $.ajax({
                                        url:"./index.php?i=3&c=entry&do=policy&p=manage&m=sz_yi&op=save_news",
                                        method:'post',
                                        data:data.field,
                                        dataType:'JSON',
