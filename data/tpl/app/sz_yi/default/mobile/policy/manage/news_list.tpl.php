        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    <div class="layui-btn layui-btn-normal layui-btn-sm" onclick="openWindow('<?php  echo $cate_id;?>',2)">新增栏目</div>
                </div>
...
<script>
    layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
        ...
        table.render({
            elem: '#mainTable'
            ,url: "./index.php?i=3&c=entry&do=policy&p=manage&m=sz_yi&op=news_list&pa=1&cate_id=<?php  echo $cate_id;?>"
            ,cellMinWidth: 200
            ,cols: [[
    ...
    function openWindow(id,typ)
    {
        if(typ==1){
            //编辑
            check_auth(2,"./index.php?i=3&c=entry&do=policy&p=manage&m=sz_yi&op=save_news&id="+id+"&cate_id="+"<?php  echo $cate_id;?>");
        }else if(typ==2){
            //新增栏目
