...
<style type="text/css">
    ...
    .info_main .line .inner { margin-left:80px;font-size: 15px;}
    ...
    <div class="info_main">
        <div class="line"><div class="title">账户类型</div><div class='info'><div class='inner'>
            <select name="account_type2" id="account_type2" style="width:100%;background: #fff;border:0;">
                <option value="1">商户私户</option>
                <option value="2">商户公户</option>
            </select>
        </div></div></div>
        ...
        <div class="line"><div class="title">账户名称</div><div class='info'><div class='inner'>
            <input type="text" name="account_name" id="account_name" placeholder="请输入账户名称">
        </div></div></div>
        ...
        <div class="line"><div class="title">分支机构</div><div class='info'><div class='inner'>
            <input type="text" name="bank_org_name" id="bank_org_name" placeholder="请输入分支机构名称">
        </div></div></div>
        <div class="line"><div class="title">银行账号</div><div class='info'><div class='inner'>
            <input type="text" name="account" id="account" placeholder="请输入银行账号">
        </div></div></div>
        <div class="line">
            <div class="title">银行卡类型</div>
            <div class='info'>
                <div class='inner'>
                    <span class="account_type" data-val="1"><i class="fa fa-check-circle-o" style="color:#0c9;"></i>储蓄卡</span>
                    <span class="account_type" data-val="2" style="margin-left:5px;"><i class="fa fa-circle-o"></i>信用卡</span>
                    <input type="text" name="account_type" id="account_type" value="1" style="display: none;">
                </div>
            </div>
        </div>
    </div>
...
<script language="javascript">
    require(['tpl', 'core'], function(tpl, core) {
        ...
        $('.info_sub').click(function() {
            ...
            core.json('domestic/liquidation',{'op':'add_account','data':data},function(json){
                if(json.status==-1){
