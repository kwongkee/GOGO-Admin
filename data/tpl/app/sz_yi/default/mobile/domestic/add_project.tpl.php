...
<div id="container">
    ...
    <div class="info_main">
        <div class="line"><div class="title">交易项目</div><div class='info'><div class='inner'><input type="text" id='project_name' placeholder="请输入交易项目名称"  value="" /></div></div></div>
    </div>
...
<script language="javascript">
    require(['tpl', 'core'], function(tpl, core) {
        $('.info_sub').click(function() {
            ...
            core.json('domestic/collection',{'op':'add_project','project_name':project_name},function(json){
                if(json.status==-1){
