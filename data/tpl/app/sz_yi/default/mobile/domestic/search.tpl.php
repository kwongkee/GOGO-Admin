...
<div id="container" style="padding-bottom:10px;">
    <div class="page_topbar">
        <div class="bon bon1 <?php echo $status==1?'bonAct':''?>" data-i="0">已支付</div>
        <div class="bon bon2 <?php echo $status==0?'bonAct':''?>" data-i="1">未支付</div>
    </div>
    ...
    <div class="button back" onclick="javascript:history.back(-1);" style="height: 44px;margin: 14px 2%;width:96%;background: #009688;border-radius: 4px;text-align: center;font-size: 16px;line-height: 44px;color: #fff;">返回</div>
</div>
