...
<style type="text/css">
    ...
    /*.table tr td:nth-of-type(1){width:72%;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;}*/
    /*.table tr td:nth-of-type(2){width:16%;text-align: center;}*/
...
<script>
    function see(id) {
        window.location.href="./index.php?i=3&c=entry&do=member&p=custompayment&m=sz_yi&oid="+id;
    }
</script>
