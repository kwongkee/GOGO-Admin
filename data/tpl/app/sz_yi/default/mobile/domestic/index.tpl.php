...
<div class="container container-fill">
    <div class="home-container clearfix">
        <!--商户管理-->
        <a href="./index.php?i=3&c=entry&do=enterprise&m=sz_yi&p=register" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="尽职调查">尽职调查</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=domestic&m=sz_yi&p=collection&op=fee" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="商户费率">商户费率</span>
        </a>
        <!--收款管理-->
        <a href="./index.php?i=3&c=entry&do=domestic&m=sz_yi&p=collection&op=project" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="项目配置中心">项目配置</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=member&p=customcollection&m=sz_yi" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="发起收款">发起收款</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=domestic&m=sz_yi&p=collection&op=search" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="收款查询">收款查询</span>
        </a>
        <!--清算管理-->
        <a href="./index.php?i=3&c=entry&do=domestic&m=sz_yi&p=liquidation&op=account" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="账户配置">账户配置</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=domestic&m=sz_yi&p=liquidation&op=withdrawal" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="提现管理">提现管理</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=domestic&m=sz_yi&p=liquidation&op=pressMoney" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="催款管理">催款管理</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=domestic&m=sz_yi&p=collection&op=notyetPay" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="待付订单">待付订单</span>
        </a>
    </div>
</div>
...
<script language="javascript">
    require(['tpl', 'core'], function(tpl, core) {
        $('.info_sub').click(function(){
            ...
            core.json('member/customcollection',{'op':'createorder','trade_price':trade_price,'project_name':project_name,'payer_name':payer_name,'payer_tel':payer_tel},function(json){
                if(json.status==-1){
