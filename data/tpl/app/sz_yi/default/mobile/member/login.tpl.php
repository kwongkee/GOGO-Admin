...
<script id="member_info" type="text/html">
    ...
    <div class="info_main">
        <div class="line"><div class="title"><?php  if($_W['uniacid']==18) { ?>账号<?php  } else { ?>手机号码<?php  } ?></div><div class='info'><div class='inner'><input type="text" id='mobile' placeholder="请输入您的<?php  if($_W['uniacid']==18) { ?>账号<?php  } else { ?>手机号码<?php  } ?>"  value="" /></div></div></div>
