...
<div class="warp">
    ...
    <div class="map">
        <div class="index_title">
            <h2><span>——</span>服务中心<span>——</span></h2>
        </div>
        <div class="index_icon">
            <ul>
                <li class="green">
                    <a href="<?php  echo $this->createMobileUrl('member/easy_deliver_buyerservice')?>">
                        <img src="../addons/sz_yi/static/images/index_05.png" alt=""><p>买家服务</p>
                    </a>
                </li>
                <li class="yellow">
                  <a href="<?php  echo $this->createMobileUrl('member/easy_deliver_sellerservice')?>">
                    <img src="../addons/sz_yi/static/images/index_06.png" alt=""><p>卖家服务</p>
                  </a>
                </li>
                <li class="blue"><img src="../addons/sz_yi/static/images/index_07.png" alt=""><p>直邮需知</p></li>
                <li class="red"><img src="../addons/sz_yi/static/images/index_08.png" alt=""><p>我要加盟</p></li>
            </ul>
        </div>
    </div>
