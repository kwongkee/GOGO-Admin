...
<script id="member_info" type="text/html">
    ...
    <div class="info_main">
        <div class="line"><div class="title">真实姓名</div><div class='info'><div class='inner'><input type="text" id='name' placeholder="请输入您的姓名"  value="" /></div></div></div>
        <div class="line" style="display:none;"><div class="title">身份证号</div><div class='info'><div class='inner'><input type="text" id='idcard' placeholder="请输入您的身份证"  value="" /></div></div></div>
        <div class="line" style="display:none;"><div class="title">省</div><div class='info'><div class='inner'><input type="text" id='province' placeholder="请输入您的省"  value="" /></div></div></div>
        <div class="line" style="display:none;"><div class="title">市</div><div class='info'><div class='inner'><input type="text" id='city' placeholder="请输入您的市"  value="" /></div></div></div>
        <div class="line" style="display:none;"><div class="title">收件地址</div><div class='info'><div class='inner'><input type="text" id='address' placeholder="请输入您的收件地址"  value="" /></div></div></div>
