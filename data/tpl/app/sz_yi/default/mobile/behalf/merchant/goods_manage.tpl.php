...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=behalf&m=sz_yi&p=merchant&op=save_product" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="拍照上架">拍照上架</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=behalf&m=sz_yi&p=merchant&op=product_manage" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
