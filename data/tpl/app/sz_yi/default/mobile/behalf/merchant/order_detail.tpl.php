            ...
            <form class="layui-form" action="" lay-filter="component-form-demo1">
                ...
                <div class="buyer_info">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block layui-select-fscon pure_text">
                            <?php  echo $buyer['realname'];?>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">身份证号:</label>
                        <div class="layui-input-block layui-select-fscon pure_text">
                            <?php  echo $buyer['id_card'];?>
                        </div>
                    </div>
                </div>
                <div class="goods_info">
                    ...
                    <div class="price">
                        ...
                        <div class="pnum"><span class="total">×<?php  echo $order['buy_num'];?></span></div>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-layout-admin">
                    <div class="layui-input-block">
                        <div class="layui-footer" style="left: 0;text-align:center;">
                            <button class="layui-btn" lay-submit="" lay-filter="component-form-demo">订单确认</button>
