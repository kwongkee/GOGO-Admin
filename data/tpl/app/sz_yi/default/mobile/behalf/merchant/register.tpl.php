            ...
            <form class="layui-form" action="" lay-filter="component-form-demo1">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="user_name" lay-verify="required" placeholder="请输入卖家名称" autocomplete="off" class="layui-input" value="<?php  echo $info['user_name'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">卖家简称</label>
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="abbreviation" lay-verify="required" placeholder="请输入卖家简称" autocomplete="off" class="layui-input" value="<?php  echo $info['behalf_info']['abbreviation'];?>">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">卖家品牌</label>
                    <div class="layui-input-block layui-select-fscon">
                        <div class="layui-upload" style="text-align:left;">
                            ...
                            <blockquote class="layui-elem-quote layui-quote-nm yulan" style="margin-top: 10px;">
                                ...
                                <div class="layui-upload-list" id="pic_list-upload-list">
                                    <?php  if(!empty($info['behalf_info']['sbrand'])) { ?>
                                    <div style="display: inline-block;margin-top:10px;overflow:visible;">
                                        <img onclick="seePic(this);" src="<?php  echo $info['behalf_info']['sbrand'];?>" class="layui-upload-img"  style="width:30px;">
                                        ...
                                        <input type="hidden" name="pic_file[0]" value="<?php  echo $info['behalf_info']['brand'];?>">
                                    </div>
                                    <?php  } ?>
                                </div>
                            </blockquote>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <div class="disf address_country">
                            <select name="address_country" lay-search style="width:20%;">
                                <?php  if(is_array($country)) { foreach($country as $k => $v) { ?>
                                <option value="<?php  echo $v['code_value'];?>" <?php  if($info['behalf_info']['address_country']==$v['code_value']) { ?>selected<?php  } ?>><?php  echo $v['code_name'];?></option>
                                <?php  } } ?>
                            </select>
                            <input type="text" name="address" lay-verify="required" placeholder="请输入卖家地址" autocomplete="off" class="layui-input" value="<?php  echo $info['address'];?>">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <select name="type" lay-filter="type" lay-verify="required">
                            <option value="1" <?php  if($info['behalf_info']['type']==1) { ?>selected<?php  } ?>>国内卖家</option>
                            <option value="2" <?php  if($info['behalf_info']['type']==2) { ?>selected<?php  } ?>>国外卖家</option>
                        </select>
                    </div>
                </div>
                <div class="user_tel <?php  if($info['behalf_info']['type']==1) { ?>show<?php  } ?>">
                    <div class="layui-form-item">
                        <label class="layui-form-label">卖家电话</label>
                        <div class="layui-input-block layui-select-fscon">
                            <div class="disf">
                                <input type="text" name="area_code" placeholder="区号" autocomplete="off" class="layui-input" value="<?php  echo $info['behalf_info']['area_code'];?>" style="width:25%;">
                                <input type="text" name="user_tel" placeholder="请输入卖家电话" id="user_tel" autocomplete="off" class="layui-input" value="<?php  echo $info['user_tel'];?>">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block layui-select-fscon">
                            <div class="disf">
                                ...
                                <div class="layui-btn layui-btn-primary" onclick="sendYzm(this,1);return false;" id="sendCode">发送验证码</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="user_email <?php  if($info['behalf_info']['type']==2) { ?>show<?php  } ?>">
                    <div class="layui-form-item">
                        <label class="layui-form-label">卖家电邮</label>
                        <div class="layui-input-block layui-select-fscon">
                            <input type="text" name="user_email" placeholder="请输入卖家电邮" id="user_email" autocomplete="off" class="layui-input" value="<?php  echo $info['user_email'];?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">验证码</label>
                        <div class="layui-input-block layui-select-fscon">
                            <div class="disf">
                                <input type="text" class="layui-input" name="code2" id="code2" value="">
                                <div class="layui-btn layui-btn-primary" onclick="sendYzm(this,2);return false;" id="sendEmailCode">发送验证码</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <textarea name="remark" id="desc" rows="3" placeholder="请输入卖家描述" class="layui-textarea"><?php  echo $info['remark'];?></textarea>
                    </div>
                </div>
...
<script>
    layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
        ...
        form.on('submit(component-form-demo)', function(data){
            $.ajax({
                url:"./index.php?i=3&c=entry&do=behalf&p=merchant&m=sz_yi&op=register",
                method:'post',
                data:data.field,
                dataType:'JSON',
        ...
        if(type==1){
            ...
            if(tel==''){
                ...
                if (!myreg.test(tel)){
                    ...
                    if(n==60){
                        timers(type);
                        $.get("./index.php?i=3&c=entry&do=behalf&m=sz_yi&p=merchant&op=sendcode&type="+type+"&mobile="+$("#user_tel").val(),function (e) {
                            e = JSON.parse(e);
                            if(e.status==0){
            ...
            if(email==''){
                ...
                var myreg = /^[a-zA-Z0-9]+([-_.][A-Za-zd]+)*@([a-zA-Z0-9]+[-.])+[A-Za-zd]{2,5}$/; //邮箱正则
                if (!myreg.test(email)) {
                    layer.msg('邮箱格式错误');
                    return false;
                } else {
                    $.get("./index.php?i=3&c=entry&do=behalf&m=sz_yi&p=merchant&op=sendcode&type=" + type + "&email=" + $("#user_email").val(), function (e) {
                        e = JSON.parse(e);
                        if (e.status == 0) {
                            layer.msg(e.result.msg);
                        } else {
