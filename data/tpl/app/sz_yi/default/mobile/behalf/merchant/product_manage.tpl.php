...
<script>
    layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
        ...
        table.render({
            elem: '#mainTable'
            ,url: "./index.php?i=3&c=entry&do=behalf&p=merchant&m=sz_yi&op=product_manage&pa=1"
            ,cellMinWidth: 200
            ,cols: [[
                {field:'id', width: 80, title: '编号'}
                ,{field:'name', title: '货品名称'}
                ,{field:'createtime', title: '上架日期'}
                ,{align:'center',  title: '操作',fixed:'right',width:120, templet: function(d){
                        return [
                            '<a onclick="openWindow('+"'"+ d.id +"'" +','+"2"+ ');" class="layui-btn layui-btn-normal layui-btn-xs">编辑</a>',
