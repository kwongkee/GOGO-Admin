...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <!--javascript:openWindow(1);-->
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=report_risk&op=display" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="申报风控">商品归类</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=risk_manage&op=display" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="风险管理">风险管理</span>
        </a>
    </div>
</div>
    ...
    function openWindow(typ){
        ...
        //
            layer.confirm('请选择入口', {
                ...
                window.location.href='./index.php?i=3&c=entry&do=declare&m=sz_yi&p=report_risk&op=display';
            }, function(){
                window.location.href='./index.php?i=3&c=entry&do=declare&m=sz_yi&p=report_risk&op=goods_cate';
            });
        }
    }
</script>
