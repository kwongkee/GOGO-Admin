            ...
            <form class="layui-form" action="" lay-filter="component-form-demo1">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="itemName[]" lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input" value="<?php  echo $val['gname'];?>">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block layui-select-fscon">
                        <input type="text" name="gcode[]" lay-verify="required" placeholder="请输入商品编码" autocomplete="off" class="layui-input" value="<?php  echo $val['gcode'];?>">
                    </div>
                </div>
                <?php  } } ?>
    ...
    $(function() {
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
            ...
            form.on('submit(component-form-demo1)', function(data){
                $.ajax({
                    url:"<?php  echo $this->createMobileUrl('declare/report_risk');?>&op=many_good_edit&ids=<?php  echo $ids;?>",
                    method:'post',
                    data:data.field,
                    dataType:'JSON',
