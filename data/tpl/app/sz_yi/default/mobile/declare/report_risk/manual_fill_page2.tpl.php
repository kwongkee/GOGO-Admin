...
<script>
    $(function() {
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
            ...
            upload.render({
                elem:'#upload',
                url:"<?php  echo $this->createMobileUrl('declare/report_risk');?>&op=upload_list2",
                auto:false,
                accept:'file',
                exts:'xls|excel|xlsx'
        ...
        $('.list_down').click(function(){
            ...
            if(ids=='' || typeof(ids)=='undefined' || ids==0){
                layer.alert('请先在系统补缺处，上传补缺清单！');return false;
            }
            //导出清单
            window.location.href="<?php  echo $this->createMobileUrl('declare/report_risk');?>&op=download_list2&type=0&ids="+ids;
        });
    });
