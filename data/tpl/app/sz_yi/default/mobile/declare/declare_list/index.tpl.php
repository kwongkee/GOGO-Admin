...
<script>
    $(function() {
        layui.use(['layer', 'form', 'table', 'upload', 'laydate','element'], function () {
            ...
            table.render({
                elem: '#mainTable'
                ,url: "<?php  echo $this->createMobileUrl('declare/declare_list');?>&pa=1"
                ,cellMinWidth: 200
                ,cols: [[
                    {field:'pre_batch_num', title: '预提编号'}
                    ,{field:'declare_status', title: '状态'}
                ]]
                ,page: true
            });
            ...
            table.render({
                elem: '#mainTable2'
                ,url: "<?php  echo $this->createMobileUrl('declare/declare_list');?>&pa=2"
                ,cellMinWidth: 200
                ,cols: [[
                    {field:'pre_batch_num', title: '预提编号'}
                    ,{field:'declare_status', title: '状态'}
            ...
            table.render({
                elem: '#mainTable3'
                ,url: "<?php  echo $this->createMobileUrl('declare/declare_list');?>&pa=3"
                ,cellMinWidth: 200
                ,cols: [[
                    {field:'pre_batch_num', title: '预提编号'}
                    ,{field:'declare_status', title: '状态'}
            ...
            table.render({
                elem: '#mainTable4'
                ,url: "<?php  echo $this->createMobileUrl('declare/declare_list');?>&pa=4"
                ,cellMinWidth: 200
                ,cols: [[
                    {field:'pre_batch_num', title: '预提编号'}
                    ,{field:'declare_status', title: '状态'}
