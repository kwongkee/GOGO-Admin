...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=index&op=add_declare" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="新增预报">新增预报</span>
        </a>

        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=index&op=manage_declare" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="管理预报">管理预报</span>
        </a>
    </div>
</div>
