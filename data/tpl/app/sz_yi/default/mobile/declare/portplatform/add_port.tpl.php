                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        ...
                        <div class="layui-form-item" style="margin-top: 15px;text-align: center;">
                            <div>
                                <button class="layui-btn layui-btn-normal tj" lay-submit lay-filter="component-form-element">立即提交</button>
                                <div class="layui-btn layui-btn-normal tj2" style="background:#999;display: none;">立即提交</div>
...
<script>
    $(function(){
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function(){
            ...
            upload.render({
                elem: '#private_key'
                ,url: "https://decl.gogo198.cn/api/Predeclare/uploadFile"
                ,accept: 'file'
                ,data: {
                    type: function(){
                        return 'private_key';
            ...
            form.on('submit(component-form-element)', function(data){
                ...
                data.field['uid'] = "<?php  echo $fans['fanid'];?>";
                $.ajax({
                    url:"https://decl.gogo198.cn/api/Predeclare/save",
                    method:'POST',
                    data:data.field,
                    dataType:'JSON',
