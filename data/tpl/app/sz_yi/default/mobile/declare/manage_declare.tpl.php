...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=index&op=pre_declare_list" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="预报列表">预报列表</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=risk&op=display" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="风控管理">风控管理</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=accrual&op=display" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="预提管理">预提管理</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=declare_list&op=display" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="申报列表">申报列表</span>
        </a>
    </div>
</div>
