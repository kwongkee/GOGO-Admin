...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=risk&op=transaction_risk_control" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="交易风控">交易风控</span>
        </a>
        <!--./index.php?i=3&c=entry&do=declare&m=sz_yi&p=report_risk&op=display-->
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=report_risk&op=declare_risk" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="申报风控">申报风控</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=declare&m=sz_yi&p=risk&op=inspect_manage" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="查验管理">查验管理</span>
        </a>
    </div>
</div>
