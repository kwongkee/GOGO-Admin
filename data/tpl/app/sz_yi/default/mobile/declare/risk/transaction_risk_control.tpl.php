...
<script>
    $(function() {
        layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
            ...
            table.render({
                elem: '#mainTable'
                ,url: "<?php  echo $this->createMobileUrl('declare/risk');?>&op=transaction_risk_control&pa=1"
                ,cellMinWidth: 200
                ,cols: [[
                    ...
                    ,{align:'center',  title: '操作', templet: function(d){
                            return [
                                '<a onclick="openWindow('+ "'"+d.pre_batch_num+"原始订单概览'" +',' + "'"+ d.id +"'" +','+"1"+ ');" class="layui-btn layui-btn-normal layui-btn-xs">原始订单概览</a>',
