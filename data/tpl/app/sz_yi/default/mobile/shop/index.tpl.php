...
<!--        <div class="list" onclick="location.href='<?php  echo $this->createMobileUrl('shop/category')?>'"><i class="fa fa-list"></i> 分类</div>-->
        <div class="topbar">
            ...
            <div class="logo"><img src="<?php  if($yzShopSet['logo']) { ?><?php  echo '/attachment/'.$yzShopSet['logo']?><?php  } else { ?>../addons/sz_yi/template/mobile/default/static/images/logo.png<?php  } ?>"></div>
            
            
            <div class="shop_name"><?php  echo $yzShopSet['name']?></div>
            <div class="menu">
                ...
                <?php  } else { ?>
                <div class="nav"  data-op='recommand'><i class="fa fa-tags"></i><br>推荐宝贝</div> 
                <?php  } ?>
            </div>
        </div>
    </div>
...
<script id='tpl_goods_list' type='text/html'>
    ...
    <div class="good" data-goodsid='<%g.id%>'>
        <div class='img'><img src="<%g.thumb%>" onerror="javascript:this.src='/attachment/images/3/default.png'"></div>
    ...
    require(['core', 'tpl'], function (core, tpl) {
        ...
        core.json('shop/index', {}, function (json) {
            ...
            $('.nav').click(function () {
                ...
                } else if (op == 'recommand') {
                    location.href = core.getUrl('shop/list', {isrecommand: 1});
                }
            });
