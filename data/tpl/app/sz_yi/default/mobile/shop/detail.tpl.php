...
<script id='goods_info'  type='text/html'>
    ...
    <div class="good_choose">
        <div class="info">
             <div class="left">
                 <img id="chooser_img" src='<%goods.thumb%>' onerror="javascript:this.src='/attachment/images/3/default.png'"/>
             </div>
             <div class="right">
    ...
    <div class="good_info1">
        ...
        <div class="price">￥<d id='marketprice'>
            ...
            <span style='float:right'><d id="stockcontainer">库存:<d id="stock"><%goods.total%></d></d> 销量:<%goods.sales%><%goods.unit%></d> 浏览:<%goods.viewcount%></span>
        </div>
   ...
   <%if goods.canbuy && goods.total!=0 && goods.timebuy=='0' && goods.userbuy=='1'  && goods.groupbuy=='1'  && goods.levelbuy=='1'%>
    ...
    <div class="good_info2">
        ...
        <div class="tab_con">
            ...
            <div class="con" id="con_1"  style='display:none'><%=goods.content%></div>
