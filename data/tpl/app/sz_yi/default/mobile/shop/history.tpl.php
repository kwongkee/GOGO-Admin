...
.history_main {height:auto; background:#fff;}
...
<script id="history_main" type="text/html">
      <div class="history_top">
        <div class="title" onclick='history.back()'><i class='iconfont icon-chevron-left'></i> 我的足迹(<%total%>)</div>
...
<script id='history_list' type='text/html'>
        ...
        <div class="history_good" data-historyid="<%value.id%>" sel='0'>
            <div class="ico"><i class="iconfont icon-circle-o" ></i></div>
...
<script language='javascript'>
    ...
    function setSelect(obj, sel){
            if(sel=='1'){
                         obj.find('i').addClass('icon-circle-o').removeClass('icon-check-circle-o').css('color', '#666');
                    }
                    else{
