...
<!--LOGO-->
<div class="header"><img src="https://decl.gogo198.cn/warehouse/images/warehouse_logo.png" alt="" class="logo" /></div>
<div class="layui-col-xs12">
    <form class="layui-form" lay-filter="component-form-element">
        <div class="upload_info info_box">
            ...
            <div class="layui-col-xs12">
                <div class="layui-col-xs3 title">仓库</div>
                <div class="layui-col-xs9 val">
                    <select name="warehouse_id" id="warehouse_id" lay-verify="required" lay-search>
                        <option value="">请选择注册时所选择的仓库</option>
...
<script>
    layui.use(['layer', 'form'], function () {
        ...
        form.on('submit(component-form-element1)', function(data){
            ...
            $.ajax({
                url:"./index.php?i=3&c=entry&p=bind_user&do=warehouse&m=sz_yi&op=bind_manager",
                method:'post',
                data:data.field,
                dataType:'JSON',
