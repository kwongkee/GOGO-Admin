...
<style>
    ...
    .menu_box .number_notice{text-align: center;position: absolute;top:27px;left:48px;background:#ff2222;width:20px;height:20px;box-sizing: border-box;border-radius: 50%;color:#fff;font-size:12px;text-overflow: ellipsis;-webkit-line-clamp: 1;white-space: nowrap;overflow: hidden;padding-top:1px;box-sizing: border-box;}
...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="white_bg">
                <div class="common_part">销售管理</div>
                <div class="layui-form-item" style="margin-bottom:0;">
                    <div class="layui-col-xs6 menu_box1">
                        <a href="./index.php?i=3&c=entry&p=sales&do=warehouse&m=sz_yi&op=goods">
                            <div class="menu_part1 disf">
                                <img src="../addons/sz_yi/static/warehouse/sales_01.png" alt="">
                    ...
                    <div class="layui-col-xs6 menu_box2 menu_box">
                        <a href="./index.php?i=3&c=entry&p=sales&do=warehouse&m=sz_yi&op=order">
                            <div class="menu_part1 disf">
                                <img src="../addons/sz_yi/static/warehouse/sales_02.png" alt="">
                                <div class="menu_part1_text">
                                    <p>订单管理</p>
                                    <p>一键管理 仓库订单</p>
                                </div>
                ...
                <div class="layui-form-item" style="margin-bottom:0;">
                    <div class="layui-col-xs6 menu_box1">
                        <a href="./index.php?i=3&c=entry&p=sales&do=warehouse&m=sz_yi&op=customer">
                            <div class="menu_part1 disf">
                                <img src="../addons/sz_yi/static/warehouse/sales_03.png" alt="">
                                <div class="menu_part1_text">
                                    <p>客户管理</p>
                                    <p>一键管理 客户信息</p>
                                </div>
                    ...
                    <div class="layui-col-xs6 menu_box2 menu_box">
                        <a href="./index.php?i=3&c=entry&p=sales&do=warehouse&m=sz_yi&op=settlement">
                            <div class="menu_part1 disf">
                                <img src="../addons/sz_yi/static/warehouse/sales_04.png" alt="">
                                <div class="menu_part1_text">
                                    <p>结算管理</p>
                                    <p>一键查看 结算记录</p>
                                </div>
                ...
                <div class="layui-form-item" style="margin-bottom:0;">
                    <div class="layui-col-xs6 menu_box1">
                        <a href="./index.php?i=3&c=entry&p=sales&do=warehouse&m=sz_yi&op=inventory">
                            <div class="menu_part1 disf">
                                <img src="../addons/sz_yi/static/warehouse/sales_05.png" alt="">
                                <div class="menu_part1_text">
                                    <p>盘点管理</p>
                                    <p>一键读取 快速管理</p>
                                </div>
