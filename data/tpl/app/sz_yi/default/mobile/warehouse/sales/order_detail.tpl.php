...
<div class="layui-col-xs12 inspection_box">
    <form class="layui-form" lay-filter="component-form-element">
        <input type="text" name="orderid" value="<?php  echo $order['id'];?>" style="display:none;">
            ...
            <div class="layui-col-xs12 g_info">
                ...
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf" style="color:#ff2222;">
                        <?php  echo $order['status_name'];?>（<?php  echo $order['program_typeName'];?>）
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                ...
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    <div class="layui-col-xs3 title">货架编号</div>
                    <div class="layui-col-xs9 val disf">
                        <input type="text" name="shelf_number" class="layui-input" value="<?php  echo $order['shelf_number'];?>">
                    </div>
                </div>
                <?php  if($order['status2']!=11 && $order['status2']!=12 && $order['status2']!=13 && $order['status2']!=14) { ?>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
    ...
    $(function() {
        layui.use(['layer', 'form', 'table', 'upload', 'element'], function () {
            ...
            form.on('submit(component-form-element1)',function(data){
                data.field['pa']=3;
                $.ajax({
                    url: "./index.php?i=3&c=entry&p=sales&do=warehouse&m=sz_yi&op=order",
                    method: 'post',
                    data: data.field,
                    dataType: 'JSON',
