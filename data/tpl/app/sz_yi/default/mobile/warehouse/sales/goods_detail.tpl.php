...
<div class="layui-col-xs12 inspection_box">
    <form class="layui-form" lay-filter="component-form-element">
        <div class="upload_info info_box">
            <input type="text" name="gid" value="<?php  echo $goods['id'];?>" style="display: none;">
            <div class="layui-col-xs12 g_info">
                <div class="layui-col-xs12">
                    <div class="layui-col-xs3 title">订单编号</div>
                    <div class="layui-col-xs9 val disf">
                        <?php  echo $goods['ordersn'];?>
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    <div class="layui-col-xs3 title">快递编号</div>
                    <div class="layui-col-xs9 val disf">
                        <?php  echo $goods['express_no'];?>
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf">
                        <input type="text" class="layui-input" name="name" lay-verify="required" value="<?php  echo $goods['name'];?>">
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf">
                        <input type="text" class="layui-input" name="money" lay-verify="required" value="<?php  echo $goods['money'];?>">
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf">
                        <input type="text" class="layui-input" name="brand" lay-verify="required" value="<?php  echo $goods['brand'];?>">
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                ...
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf">
                        <div class="layui-col-xs6">
                            <div class="hui-number-box" min="1" max="100000">
                                <div class="reduce">-</div>
                                <input type="number" name="num" value="<?php  echo $goods['num'];?>" lay-verify="required" class="layui-input" />
                                <div class="add">+</div>
                            </div>
                        </div>
                        <div class="layui-col-xs6">
                            <select name="unit_name" id="unit_name" lay-verify="required">
                                <?php  if(is_array($unit)) { foreach($unit as $k => $v) { ?>
                                <option value="<?php  echo $v['code_value'];?>" <?php  if($goods['unit_name']==$v['code_name']) { ?>selected<?php  } ?>><?php  echo $v['code_name'];?></option>
                                <?php  } } ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf">
                        <input type="text" class="layui-input" name="netwt" lay-verify="required" value="<?php  echo $goods['netwt'];?>">
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf">
                        <input type="text" class="layui-input" name="grosswt" lay-verify="required" value="<?php  echo $goods['grosswt'];?>">
                    </div>
                </div>
                ...
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf">
                        <input type="text" class="layui-input" name="true_volumn" value="<?php  echo $goods['true_volumn'];?>" style="width: 70%;">
                        (长*宽*高)
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val disf">
                        <?php  echo $goods['shelf_number'];?>
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="info_box info_btn_box" style="margin: 10px 0 20px;text-align: center;">
                    <div>
                        <button class="layui-btn layui-btn-normal" lay-submit lay-filter="component-form-element1" style="width:90%;">立即修改</button>
                    </div>
                </div>
            </div>
        </div>
