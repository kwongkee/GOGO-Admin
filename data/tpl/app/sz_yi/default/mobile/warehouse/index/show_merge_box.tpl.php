        ...
        <div class="upload_info info_box">
            ...
            <?php  if($merge_order['status']==1) { ?>
                ...
                <!--<div class="layui-col-xs12 service_price disf">-->
                    <!--<div class="layui-col-xs3 title add_height">合并费用(HK$)</div>-->
                    <!--<div class="layui-col-xs9 val">-->
                        <!--$service_price-->
                    <!--</div>-->
                <!--</div>-->
...
<script>
    ...
    layui.use(['layer', 'jquery', 'form', 'element', 'upload'], function () {
        ...
        form.on('submit(component-form-element1)', function (data) {
            ...
            //     layer.msg('请填写附加费用');return false;
            // }
            $.ajax({
                url: "./index.php?i=3&c=entry&p=index&do=warehouse&m=sz_yi&op=sure_merge",
                method: 'post',
                data: data.field,
                dataType: 'JSON',
