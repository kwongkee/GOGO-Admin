...
<div class="layui-col-xs12 inspection_box">
    <form class="layui-form" lay-filter="component-form-element">
        ...
        <div class="upload_info info_box">
            <!--拒绝通过和待审核时显示-->
            <?php  if(( $attach_info['program_type']==23 || $attach_info['program_type']==25) ) { ?>
            <div class="line layui-col-xs12 spin_status"></div>
            <div class="layui-col-xs12 disf spin_status">
                <div class="layui-col-xs3 title">剔除状态</div>
                <div class="layui-col-xs9 val">
                    <select name="c_status" id="c_status" lay-filter="c_status" lay-verify="required">
                        <option value="0">请选择剔除状态</option>
                        <option value="1">同意剔除</option>
                        <option value="-1">拒绝剔除</option>
                    </select>
                </div>
            </div>
            <div class="line layui-col-xs12"></div>
            <div class="layui-col-xs12 remark disf">
            ...
            <div class="layui-col-xs12 disf service_price">
                ...
                <div class="layui-col-xs9 val">
                    <input type="number" class="layui-input" name="service_price" id="service_price" placeholder="请填写服务收费金额（HK$）" value="1">
                </div>
            </div>
            ...
            <?php  } else { ?>
                <!--if ($order['pay_status']==2 && $attach_info['program_type']!=26)-->
                <!--<div class="line layui-col-xs12 spin_status"></div>-->
                <!--<div class="layui-col-xs12 disf spin_status">-->
                    <!--<div class="layui-col-xs3 title">剔除状态</div>-->
                    <!--<div class="layui-col-xs9 val">-->
                    ...
                    <!--</div>-->
                <!--</div>-->
                <!--<input type="text" name="c_status" value="2" style="display: none;" class="layui-input">-->
                <!--<div class="info_box info_btn_box" style="margin: 10px 0 20px;text-align: center;">-->
                    <!--<div>-->
                        <!--<button class="layui-btn layui-btn-normal" lay-submit lay-filter="component-form-element1" style="width:90%;">立即提交</button>-->
                    <!--</div>-->
                ...
                <div class="layui-col-xs12 remark disf">
                    <div class="layui-col-xs3 title add_height">备注</div>
                    <div class="layui-col-xs9 val">
                        <?php  echo $attach_info['remark'];?>
                    </div>
                </div>
                <!--<div class="line layui-col-xs12"></div>-->
                <!--<div class="layui-col-xs12 service_price disf">-->
                    <!--<div class="layui-col-xs3 title add_height">剔除费用(HK$)</div>-->
                    <!--<div class="layui-col-xs9 val">-->
                        <!--(HK$) $service_series-->
                    <!--</div>-->
                <!--</div>-->
...
<script>
    ...
    layui.use(['layer', 'jquery', 'form', 'element', 'upload'], function () {
        ...
        form.on('submit(component-form-element1)', function (data) {
            ...
            if(data.field['c_status']==1 && ($('#service_price').val()=='' || typeof($('#service_price').val())=='undefined')){
                layer.msg('请填写服务费用');return false;
            }
            $.ajax({
                url: "./index.php?i=3&c=entry&p=index&do=warehouse&m=sz_yi&op=sure_rejection",
                method: 'post',
                data: data.field,
                dataType: 'JSON',
