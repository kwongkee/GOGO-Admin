...
<div class="layui-col-xs12 inspection_box">
    <form class="layui-form" lay-filter="component-form-element">
        ...
        <div class="upload_info info_box">
            <div class="layui-col-xs12 title_bar">货物退运信息<span style="color:#ff2222;">*</span></div>
            ...
            <?php  if(!empty($order['return_info']['domestic_return_address'])) { ?>
                <div class="layui-col-xs12 title_bar">退运地址信息<span style="color:#ff2222;">*</span></div>
                <div class="layui-col-xs12 g_info">
                    <div class="layui-col-xs12">
                        <div class="layui-col-xs3 title">退运地址</div>
                        <div class="layui-col-xs9 val disf">
                            <?php  echo $order['return_info']['domestic_return_address'];?>
                        </div>
                    </div>
                    <div class="line layui-col-xs12"></div>
                    <div class="layui-col-xs12">
                        ...
                        <div class="layui-col-xs9 val disf">
                            <?php  echo $order['return_info']['domestic_addressee'];?>
                        </div>
                    </div>
                    <div class="line layui-col-xs12"></div>
                    <div class="layui-col-xs12">
                        ...
                        <div class="layui-col-xs9 val disf">
                            <?php  echo $order['return_info']['domestic_tel'];?>
                        </div>
                    </div>
                </div>
            <?php  } ?>
        ...
        <!--退运信息-->
        <?php  if(!empty($is_return['id'])) { ?>
        <div class="upload_info info_box">
            <div class="layui-col-xs12 title_bar">退运快递信息<span style="color:#ff2222;">*</span></div>
            <div class="layui-col-xs12 disf">
                <div class="layui-col-xs3 title">快递公司</div>
                <div class="layui-col-xs9 val disf">
                    <?php  echo $order['warehouse_return_info']['express_company'];?>
                </div>
            </div>
            <div class="line layui-col-xs12"></div>
            <div class="layui-col-xs12 disf">
                ...
                <div class="layui-col-xs9 val">
                    <?php  echo $order['warehouse_return_info']['express_no'];?>
                </div>
            </div>
            <div class="line layui-col-xs12"></div>
            <div class="layui-col-xs12 disf">
                <div class="layui-col-xs3 title add_height">仓库备注</div>
                <div class="layui-col-xs9 val">
                    <?php  echo $is_return['remark'];?>
                </div>
            </div>
        </div>
        <?php  } else { ?>
            <div class="upload_info info_box">
                <div class="layui-col-xs12 title_bar">填写退运快递信息<span style="color:#ff2222;">*</span></div>
                <div class="layui-col-xs12 disf">
                    <div class="layui-col-xs3 title">快递公司</div>
                    <div class="layui-col-xs9 val disf">
                        <select name="express_company" id="express_company" lay-search lay-verify="required">
                ...
                <div class="layui-col-xs12 disf">
                    <div class="layui-col-xs3 title">快递单号</div>
                    <div class="layui-col-xs9 val">
                        <input type="text" class="layui-input" lay-verify="required" name="express_no"
                               placeholder="请输入快递单号">
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                ...
                <div class="info_box info_btn_box" style="margin: 10px 0 20px;text-align: center;">
                    <div>
                        <button class="layui-btn layui-btn-normal" lay-submit lay-filter="component-form-element1" style="width:90%;">立即退运</button>
                    </div>
                </div>
            </div>
        <?php  } ?>
...
<script>
    ...
    layui.use(['layer', 'jquery', 'form', 'element', 'upload'], function () {
        ...
        form.on('submit(component-form-element1)', function (data) {
            ...
            $.ajax({
                url: "./index.php?i=3&c=entry&p=index&do=warehouse&m=sz_yi&op=sure_return",
                method: 'post',
                data: data.field,
                dataType: 'JSON',
