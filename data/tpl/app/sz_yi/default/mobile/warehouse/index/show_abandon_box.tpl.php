...
<div class="layui-col-xs12 inspection_box">
    <form class="layui-form" lay-filter="component-form-element">
        ...
        <div class="upload_info info_box">
            <div class="layui-col-xs12 title_bar">货物弃货信息<span style="color:#ff2222;">*</span></div>
        ...
        <!--弃货信息-->
        <?php  if(!empty($is_abandon['id'])) { ?>
            <div class="upload_info info_box">
                <div class="layui-col-xs12 title_bar">填写弃货信息<span style="color:#ff2222;">*</span></div>
                <div class="layui-col-xs12">
                    <div class="layui-col-xs3 title">弃货地址</div>
                    <div class="layui-col-xs9 val disf">
                        <?php  echo $order['warehouse_abandon_info']['abandon_address'];?>
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val">
                        <?php  echo $order['warehouse_abandon_info']['abandon_addressee'];?>
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    ...
                    <div class="layui-col-xs9 val">
                        <?php  echo $order['warehouse_abandon_info']['abandon_tel'];?>
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
        ...
        <?php  } else { ?>
            <div class="upload_info info_box">
                ...
                <div class="layui-col-xs12">
                    <div class="layui-col-xs3 title">弃货地址</div>
                    <div class="layui-col-xs9 val disf">
                        <input type="text" class="layui-input" lay-verify="required" name="abandon_address"
                               placeholder="请输入弃货地址">
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    <div class="layui-col-xs3 title">联系人</div>
                    <div class="layui-col-xs9 val">
                        <input type="text" class="layui-input" lay-verify="required" name="abandon_addressee"
                               placeholder="请输入联系人">
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                <div class="layui-col-xs12">
                    <div class="layui-col-xs3 title">联系电话</div>
                    <div class="layui-col-xs9 val">
                        <input type="text" class="layui-input" lay-verify="required" name="abandon_tel"
                               placeholder="请输入联系电话">
                    </div>
                </div>
                <div class="line layui-col-xs12"></div>
                ...
                <div class="info_box info_btn_box" style="margin: 10px 0 20px;text-align: center;">
                    <div>
                        <button class="layui-btn layui-btn-normal" lay-submit lay-filter="component-form-element1" style="width:90%;">立即弃货</button>
                    </div>
                </div>
            </div>
        <?php  } ?>
...
<script>
    ...
    layui.use(['layer', 'jquery', 'form', 'element', 'upload'], function () {
        ...
        form.on('submit(component-form-element1)', function (data) {
            ...
            $.ajax({
                url: "./index.php?i=3&c=entry&p=index&do=warehouse&m=sz_yi&op=sure_abandon",
                method: 'post',
                data: data.field,
                dataType: 'JSON',
