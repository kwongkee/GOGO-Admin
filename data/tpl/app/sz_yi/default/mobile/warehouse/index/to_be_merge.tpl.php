...
<div class="layui-col-xs12">
    <div class="info_search">
        ...
        <div class="info_box info_search_box">
            ...
            <div class="line layui-col-xs12"></div>
            <div class="layui-col-xs12 disf">
                合并状态：<span style="color:#ff2222;"><?php  echo $v['merge_info']['merge_status'];?></span>
            </div>
            ...
            <div class="line layui-col-xs12"></div>
            <div class="layui-col-xs12 disf">
                申请合并时间：<?php  echo date('Y-m-d H:i',$v['createtime'])?>
            </div>
            <div class="line layui-col-xs12"></div>
            <div class="layui-col-xs12" style="padding:15px 10px;box-sizing: border-box;text-align: right;">
                <div class="layui-btn layui-btn-primary" style="border:1px solid #1790FF;color:#1790FF;" onclick="chayan(<?php  echo $v['id'];?>,'<?php  echo $v['ordersn'];?>',<?php  echo $v['status2'];?>)">立即合并
                </div>
            </div>
        </div>
        <?php  } } ?>
...
<script>
    ...
    function chayan(id,ordersn,status2) {
        ...
        layer.open({
            ...
            title:"立即合并["+ordersn+"]",
            area: ['100%', '100%'], //宽高
            content: './index.php?i=3&c=entry&p=index&do=warehouse&m=sz_yi&op=show_merge_box&orderid='+id+'&ordersn='+ordersn+'&status2='+status2
        });
