...
<html>
    ...
    <body>
                    ...
                    <form class="layui-form" action="" lay-filter="component-form-demo1">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                 <div id="merchants" class="xm-select-demo"></div>
                            </div>
                        </div>
        ...
        <script src="../addons/sz_yi/static/js/layui/xm-select.js"></script>
        <!--<script src="https://shop.gogo198.cn/collect_website/public/static/hadmin/assets/layui/xm-select.js"></script>-->
        <script>
            layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
                ...
                form.on('submit(component-form-demo)', function(data){
                    $.ajax({
                        url:"./index.php?i=3&c=entry&do=checkprice&p=index&m=sz_yi&op=share_merchant",
                        method:'post',
                        data:data.field,
                        dataType:'JSON',
