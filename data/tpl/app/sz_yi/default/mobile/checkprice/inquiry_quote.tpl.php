...
<script>
    layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
        ...
        table.render({
            elem: '#mainTable'
            ,url: "./index.php?i=3&c=entry&do=checkprice&p=index&m=sz_yi&op=inquiry_quote&pa=1&id=<?php  echo $inquiry_id;?>"
            ,cellMinWidth: 200
            ,cols: [[
                {field:'id', title: '报价序号'},
                ...
                ,{align:'center',  title: '操作',fixed:'right',width:120, templet: function(d){
                        return [
                            '<a onclick="openWindow('+"'"+ d.id +"'" +','+"1"+ ');" class="layui-btn layui-btn-primary layui-btn-xs">查看详情</a>',
                        ].join('');
                    } }
            ]]
            ,page: false
