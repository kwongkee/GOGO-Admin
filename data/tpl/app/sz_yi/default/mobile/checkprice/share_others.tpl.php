    ...
    <div class="layui-card">
        <div class="layui-card-body" style="padding:0;padding-bottom: 10px;">
            <form class="layui-form" action="" lay-filter="component-form-demo1">
                ...
                <div class="layui-form-item">
                    <div class="layui-form-label">通知其他人</div>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" placeholder="请用顿号“、”隔开" name="other_contact" lay-verify="required">
                    </div>
                </div>
...
<script>
    layui.use(['layer', 'form', 'table', 'upload', 'laydate'], function () {
        ...
        form.on('submit(component-form-demo)', function(data){
            $.ajax({
                url:"./index.php?i=3&c=entry&do=checkprice&p=index&m=sz_yi&op=share_others",
                method:'post',
                data:data.field,
                dataType:'JSON',
