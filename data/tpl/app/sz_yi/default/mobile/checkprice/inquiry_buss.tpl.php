...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=checkprice&m=sz_yi&p=index&op=inquiry_list&id=<?php  echo $v['id'];?>" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="新增预报"><?php  echo $v['name'];?></span>
        </a>
        <?php  } } ?>
    </div>
</div>
