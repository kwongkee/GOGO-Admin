...
<div class="container container-fill">
    <div class="home-container clearfix">
        ...
        <a href="./index.php?i=3&c=entry&do=checkprice&m=sz_yi&p=index&op=inquiry_buss" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="新增预报">询价中心</span>
        </a>
        <?php  } ?>
        <?php  if($_SESSION['account']['merch_status']==2) { ?>
        <a href="./index.php?i=3&c=entry&do=checkprice&m=sz_yi&p=quote&op=quote_list" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="管理预报">报价中心</span>
        </a>
        <?php  } ?>
    </div>
</div>
