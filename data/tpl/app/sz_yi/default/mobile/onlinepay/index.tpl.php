...
<div class="container container-fill">
    <div class="home-container clearfix">
        <a href="./index.php?i=3&c=entry&do=onlinepay&m=sz_yi&p=index&op=status1" class="box-item" style="width:120px !important;position:relative;">
            ...
            <span style="color:;" title="尽职调查">已通知待确认</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=onlinepay&m=sz_yi&p=index&op=status2" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="商户费率">已确认待付款</span>
        </a>
        <a href="./index.php?i=3&c=entry&do=onlinepay&m=sz_yi&p=index&op=status3" class="box-item" style="width:120px !important;position:relative;">
            <i style="background:url('https://shop.gogo198.cn/attachment/images/3/2021/01/D55WDd00o87R8mDDRXW500rjDMom7W.png') no-repeat;background-size:100%;" class="icon"></i>
            <span style="color:;" title="项目配置中心">已付款待确认</span>
        </a>
    </div>
</div>
