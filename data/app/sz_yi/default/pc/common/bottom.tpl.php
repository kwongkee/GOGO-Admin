    ...
    <p class="copyright">
        ...
        <?php  if($_W['uniacid']==18 || $_GPC['i']==18) { ?>
            <p style="text-align: center;" class="fot_18">
                <span style="color: rgb(119, 119, 119); font-family: " helvetica="" font-size:="" text-align:="" background-color:=""></span><span style="color: rgb(119, 119, 119); font-family: " helvetica="" font-size:="" text-align:="" background-color:="">Copyright 2003 - 2021 購購網 版权所有</span><a href="http://beian.miit.gov.cn/" target="_blank" style="box-sizing: border-box; background:none; color: rgb(119, 119, 119); text-decoration-line: none; font-family: " helvetica="" font-size:="16" text-align:="" white-space:="">&nbsp;粤ICP备09003656号-7</a><a href="http://beian.miit.gov.cn/" target="__blank" style="color: rgb(119, 119, 119); text-decoration: underline; font-size: 14px;"><span style="font-size: 14px;"></span></a>
            </p>
        <?php  } ?>
        
        <?php  if($_W['uniacid']==3 || $_GPC['i']==3) { ?>
            <p style="text-align: center;" class="fot_3">
                <span style="color: rgb(119, 119, 119); font-family: " helvetica="" font-size:="" text-align:="" background-color:=""></span><span style="color: rgb(119, 119, 119); font-family: " helvetica="" font-size:="" text-align:="" background-color:="">Copyright 2003 - 2021 購購網 版权所有</span><a href="http://beian.miit.gov.cn/" target="_blank" style="box-sizing: border-box; background:none; color: rgb(119, 119, 119); text-decoration-line: none; font-family: " helvetica="" font-size:="16" text-align:="" white-space:="">&nbsp;粤ICP备09003656号-11</a><a href="http://beian.miit.gov.cn/" target="__blank" style="color: rgb(119, 119, 119); text-decoration: underline; font-size: 14px;"><span style="font-size: 14px;"></span></a>
            </p>
        <?php  } ?>
        <!--php echo htmlspecialchars_decode($this->yzShopSet['pccopyright'])-->
        <!--if $this->yzShopSet['pccopyright']==''-->
        <!--    <p style="text-align: center;">-->
        <!--        <span style="color: rgb(119, 119, 119); font-family: " helvetica="" font-size:="" text-align:="" background-color:=""><a style="box-sizing: border-box; background:none; color: rgb(119, 119, 119); text-decoration-line: none; font-size:14px;" href="http://www.gogo198.net/" target="__blank">佛山市钜銘商務資訊服務有限公司</a></span>-->
        <!--    </p>-->
        <!--    <p style="text-align: center;">-->
        <!--        <span style="color: rgb(119, 119, 119); font-family: " helvetica="" font-size:="" text-align:="" background-color:=""></span><span style="color: rgb(119, 119, 119); font-family: " helvetica="" font-size:="" text-align:="" background-color:="">Copyright 2003 - 2020 購購網 版权所有</span><a href="http://beian.miit.gov.cn/" target="_blank" style="box-sizing: border-box; background:none; color: rgb(119, 119, 119); text-decoration-line: none; font-family: " helvetica="" font-size:="16" text-align:="" white-space:="">&nbsp;粤ICP备09003656号</a><a href="http://beian.miit.gov.cn/" target="__blank" style="color: rgb(119, 119, 119); text-decoration: underline; font-size: 14px;"><span style="font-size: 14px;"></span></a>-->
        <!--    </p>-->
        <!--    <p>-->
        <!--        <br/>-->
        <!--    </p>-->
