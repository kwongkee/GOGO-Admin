...
<div id='container' class="rightlist">
    <div class="pc-cen">
        <div class="topbar">
            ...
            <div class="user_info">
                <div class="user_name" <?php  if($set['levelurl']!='') { ?>onclick='location.href="<?php  echo $set['levelurl'];?>"'<?php  } ?>><?php  echo $member['nickname'];?> </div>
                <div class="user-dj">
                    <?php  if($level) { ?>
                    ...
                    <?php  if($member['bonus_area']) { ?>
                        ...
                        <?php  } ?>
                    <?php  } ?>
                    <?php  if($set['levelurl']!='') { ?><i class='fa fa-question-circle' <?php  if(!empty($set['levelurl'])) { ?>onclick='location.href="<?php  echo $set['levelurl'];?>"'<?php  } ?>></i><?php  } ?>
                </div>
        ...
        <div class="top-fx">
            <div class="top_2">
                ...
                <div class="pr-jine">
                    <em><?php  echo $member['commission_ok'];?></em>
            ...
            <div class="top_1">
                <div class="text">
                <?php  echo $this->set['texts']['commission_total']?>：<?php  echo $member['commission_total'];?> 元</div>
    ...
    <div class="menu">  
        ...
        <?php  } ?>
        <a href="<?php  echo $this->createPluginMobileUrl('bonus/log')?>"><div class="nav nav1"><i class="fa fa-random  fa-3x" style="color:#ca81d1;"></i><div class="title"><?php  echo $this->set['texts']['commission_detail']?></div><div class="con"><?php  echo $this->set['texts']['commission']?>明细</div></div></a>        
