...
<script language='javascript'>
    ...
    require(['tpl', 'core'], function(tpl, core) {
             core.pjson('merchant/orderj', {'op':'<?php  echo $_GPC['op'];?>', page:page, status: '<?php  echo $_GPC['status'];?>'}, function(json) {

                    $("#container").html(tpl('tpl_order_list'));

                    $('.nav').click(function() {
                        var status = $(this).data('status');
                        location.href = core.getUrl('plugin/merchant/orderj', {'op':'order',status: status});
                    })
...
<script id='tpl_main' type='text/html'>
    ...
    <div class="top">
        ...
        <div class="top_2"><?php  echo $commission_ok?><a <?php  if($commission_ok<=0 || !empty($center_info['limit_day']) ) { ?>href="javascript:;"<?php  } else { ?>href="<?php  echo $this->createPluginMobileUrl('merchant/applyg')?>"<?php  } ?> id='withdraw' ><span <?php  if($commission_ok<=0 || !empty($center_info['limit_day']) ) { ?>class='disabled'<?php  } ?> >提现</span></a></div>

    </div> 

    <div class="menu">  

        <a <?php  echo "href='".$this->createPluginMobileUrl('merchant/logg')."'";?>><div class="nav nav1"><i class="fa fa-cny fa-3x"></i><div class="title">提现记录</div><div class="con"><span><?php  echo $apply_total?></span>元</div></div></a>

        <a <?php  echo "href='".$this->createPluginMobileUrl('merchant/orderj',array('op' => 'order','type'=>$_GPC['type']))."'";?>><div class="nav nav3"><i class="fa fa-list fa-3x"></i><div class="title">我的订单</div><div class="con"><span><?php  echo $ordercount0;?></span>个订单</div></div></a>
        <a href="<?php  echo $this->createPluginMobileUrl('merchant/team')?>"><div class="nav nav1"><i class="fa fa-user  fa-3x" style="color:#98cd37;"></i><div class="title">我的供应商</div><div class="con"><span><?php  echo $suppliercount?></span> 人</div></div></a>
...
<script language="javascript">
    ...
    require(['tpl', 'core'], function(tpl, core) {
        ...
        core.pjson('merchant/applyg',{},function(json){
