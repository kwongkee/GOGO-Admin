...
<footer id="footer-nav">
    <ul class="menu-list" style="margin:0">
        <li <?php  if($footer_current=='first') { ?>class='active'<?php  } ?>><a href="<?php  echo $this->createMobileUrl('shop')?>"><i class="iconfont icon-<?php  echo $this->footer['first']['ico']?>"></i><span>首页</span></a></li>
