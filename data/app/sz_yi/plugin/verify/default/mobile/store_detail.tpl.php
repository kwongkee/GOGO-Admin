                ...
                <div class="t2">
                    ...
                    <div class="c">
                        ...
                        <div class="p2">
                            ...
                            <span class="s2">门市价:￥<%grow.peoductprice%></span>
                        </div>
                    </div>
                </div>
                <%/each%>
        ...
        <div class="main">
            <ul>
                <%each near_goods as nrow%>
                    <li>
                        <a href="<?php  echo $this->createMobileUrl('shop/detail')?>&id=<%nrow.id%>&shop_name=<%nrow.storename%>">
                            <div class="img">
                                <img src="<%nrow.thumb%>" />
                            </div>
                            <div class="text">
    ...
    <%each list as comment%>
        <div class='comment'>
            <div class='info'>
                ...
                <div class='level'>
                    <%if comment.level>=1%><i class='fa fa-star'></i>
                        <%else%><i class='fa fa-star-o'></i>
                            <%/if%>
                                <%if comment.level>=2%><i class='fa fa-star'></i>
                                    <%else%><i class='fa fa-star-o'></i>
                                        <%/if%>
                                            <%if comment.level>=3%><i class='fa fa-star'></i>
                                                <%else%><i class='fa fa-star-o'></i>
                                                    <%/if%>
                                                        <%if comment.level>=4%><i class='fa fa-star'></i>
                                                            <%else%><i class='fa fa-star-o'></i>
                                                                <%/if%>
                                                                    <%if comment.level>=5%><i class='fa fa-star'></i>
                                                                        <%else%><i class='fa fa-star-o'></i>
                                                                            <%/if%>
                </div>
            </div>
            ...
            <%if comment.images.length>0%>
                <div class='imgs'>
                    <%each comment.images as img%><img src='<%img%>' style='width:30px;height:30px;' />
                        <%/each%>
                </div>
                <%/if%>
                    <%if comment.reply_content!=''%>
                        <div class='content' style='margin-top:5px;'><span style='color:#ff6600'>[回复]</span>
                            <%comment.reply_content%>
                        </div>
                        <%if comment.reply_images.length>0%>
                            <div class='imgs'>
                                <%each comment.reply_images as img%><img src='<%img%>' style='width:30px;height:30px;' />
                                    <%/each%>
                            </div>
                            <%/if%>
                                <%/if%>
                                    ...
                                    <%if comment.append_content!=''%>
                                        <div class='content' style='margin-top:5px;'><span style='color:#ff6600'>[追加]</span>
                                            <%comment.append_content%>
                                        </div>
                                        <%if comment.append_images.length>0%>
                                            <div class='imgs'>
                                                <%each comment.append_images as img%><img src='<%img%>' style='width:30px;height:30px;' />
                                                    <%/each%>
                                            </div>
                                            <%/if%>
                                                <%/if%>
                                                    ...
                                                    <%if comment.append_reply_content!=''%>
                                                        ...
                                                        <%if comment.append_reply_images.length>0%>
                                                            <div class='imgs'>
                                                                <%each comment.append_reply_images as img%><img src='<%img%>' style='width:30px;height:30px;' />
                                                                    <%/each%>
                                                            </div>
                                                            <%/if%>
                                                                <%/if%>
...
<script language="JavaScript">
    require(['core', 'tpl'], function(core, tpl) {
        core.pjson('verify/store_detail', {
            id: "<?php  echo $_GPC['id'];?>"
        }, function(json) {
