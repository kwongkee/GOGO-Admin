    ...
    J = function() {
        ...
        d.prototype = {
            ...
            createDialogBox: function() {
                var a = g.createElement("div");
                a.style.cssText = "margin:0;padding:0 2.5%;background:#fff;width:95%;border:none;z-index:10000;";
                a.id = "easyDialogBox";
                return a
            },
        ...
        D = {
            open: function(a) {
                ...
                if (c.follow) h.style.marginLeft = h.style.marginTop = "0px";
                    ...
                    //默认识别margin位移 h.style.marginLeft = "-" + (l ? e / 2 : t / 2) + "px";
                    //默认识别margin位移 h.style.marginTop = "-" + (k ? f / 2 : i / 2) + "px"
