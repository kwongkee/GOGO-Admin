...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_article` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='营销文章' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_article_log` (
  ...
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='点赞/阅读记录' AUTO_INCREMENT=24 ;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_article_share` (
  ...
  KEY `idx_aid` (`aid`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='用户分享数据' AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods` (
  ...
  KEY `idx_deleted` (`deleted`),
  KEY `idx_tcate` (`tcate`),
  KEY `idx_scate` (`tcate`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_option` (
  ...
  KEY `idx_displayorder` (`displayorder`),
  KEY `idx_productsn` (`productsn`) USING BTREE
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=8519 ;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_goods_spec_item` (
  ...
  KEY `idx_show` (`show`),
  KEY `idx_displayorder` (`displayorder`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4571 ;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_order_goods` (
  ...
  `prohibitrefund` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '禁止资金',
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_orderid` (`orderid`),
  KEY `idx_goodsid` (`goodsid`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5096 ;
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_sms_set` (
  ...
  `aliyun_appcode` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_verifygoods_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `verifygoodsid` int(11) DEFAULT '0',
  `salerid` int(11) DEFAULT '0',
  `storeid` int(11) DEFAULT '0',
  ...
  KEY `salerid` (`salerid`) USING BTREE,
