...
if(!empty($_GPC['oauth'])&& $_GPC['oauth'] == 'yes' ) {
	...
	if(isset($newOpenid['newOpenid']) && $newOpenid['newOpenid'] != '') {

		$str = '&orderid='.$_GPC['orderid'].'&newOpenid='.$newOpenid['newOpenid'].'&openid='.$_GPC['opid'].'&uniacid=14&type=tgwechat1&http=ok';
		$payurl = $payurl.$str;
		...
		$notifyUrl = "http://shop.gogo198.cn/addons/ewei_shopv2/payment/oauth/notify.php";
