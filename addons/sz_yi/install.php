...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_bonus` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='分红明细' AUTO_INCREMENT=7 ;

CREATE TABLE IF NOT EXISTS `ims_sz_yi_bonus_apply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='分红单商品表' AUTO_INCREMENT=94 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_bonus_level` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='分红代理等级表' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_bonus_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='分红日志' AUTO_INCREMENT=18 ;

CREATE TABLE IF NOT EXISTS `ims_sz_yi_book` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_cancel_goods` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门店取消配送表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_cashier_withdraw` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='收银台商户提现表' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_channel_apply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='渠道商申请提现' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_channel_level` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='渠道商等级' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_channel_merchant` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='渠道商推荐员' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_channel_order_goods_profit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='渠道商商品利润' AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_channel_stock` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='渠道商库存' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_channel_stock_log` (
  ...
  `mid` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='渠道商进货记录' AUTO_INCREMENT=12 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_hotel_room` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_hotel_room_price` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `union_id` varchar(100) default '0',
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_member_aging_rechange` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `paymethod` tinyint(1) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_order_room` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `orderid` int(11) DEFAULT '0',
  `roomdate` int(11) DEFAULT '0',
  `thisdate` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_print_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_store_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  `thumb` varchar(255) DEFAULT NULL COMMENT '分类图片',
  ...
  KEY `idx_isrecommand` (`isrecommand`),
  KEY `idx_ishome` (`ishome`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='门店分类表' AUTO_INCREMENT=2 ;

CREATE TABLE IF NOT EXISTS `ims_sz_yi_store_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(100) DEFAULT '',
  `goodsid` int(11) DEFAULT '0',
  ...
  KEY `idx_openid` (`openid`),
  KEY `idx_deleted` (`deleted`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门店商品表' AUTO_INCREMENT=1 ;

CREATE TABLE IF NOT EXISTS `ims_sz_yi_store_withdraw` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `withdraw_no` varchar(255) NOT NULL,
  `openid` varchar(50) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门店提现表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_temp_date` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_yunbi_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `mid` int(11) NOT NULL,
  `openid` varchar(255) NOT NULL,
...
INSERT INTO `ims_sz_yi_plugin` (`id`, `displayorder`, `identity`, `name`, `version`, `author`, `status`, `category`, `desc`) VALUES
...
alter table ims_mc_members add credit20 decimal(10,2);

CREATE TABLE IF NOT EXISTS `ims_sz_yi_yunprint_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
  `sid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS ims_sz_yi_dismantling_conditions(
	`id` int(10) not null auto_increment PRIMARY key,
	`hs_code` varchar(100) not null comment '税号' 
)ENGINE=INNODB default CHARSET='utf8mb4' COMMENT='订单拼单下单条件';

CREATE TABLE IF NOT EXISTS `ims_member` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `union_id` varchar(100) not null default '0' COMMENT '微信开放平台id',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tel` (`phone`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='总会员表';

create table shop.ims_member_family(
	`id` int(10) not null auto_increment primary key,
    `name` varchar(255) not null comment '姓名',
    `bind` varchar(10) not null comment '关系',
    `sex` enum('男','女','保密') not null default '保密',
    `birth_date` varchar(100) not null comment '00000000', 
...
if(!pdo_fieldexists('mc_members', 'credit20')) {
	pdo_query("ALTER TABLE ".tablename('mc_members')." ADD    `credit20` decimal(10,2) DEFAULT '0.00';");
}
?>
