...
if (!class_exists('CouponModel')) {
	class CouponModel extends PluginModel
	{
		...
		public function useConsumeCoupon($logid5 = 0)
		{
			...
			$order = pdo_fetch('select ordersn,createtime,couponid,price,goodsprice from ' . tablename('sz_yi_order') . ' where id=:id and status>=0 and uniacid=:uniacid limit 1', array(':id' => $logid5, ':uniacid' => $_W['uniacid']));
