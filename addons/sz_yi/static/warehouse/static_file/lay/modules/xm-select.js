	...
	65: function(e, t, n) {
		...
		function T(e, t, n, o, r, i, l) {
			...
			a = null;
				...
				for (s = l, c = 0;
				(s = s.nextSibling) && c < o.length; c += 2) if (s == i) break e;
					...
					value: function(e) {
						...
						if (e.paging) {
							...
							var V = {
								...
								U = {},
								F = {};
							T <= 1 && (U = V), T == M && (F = V), this.state.pageIndex !== T && this.changePageIndex(T), this.size = M, D = O("div", {
								class: "xm-paging"
							}, O("span", {
								style: U,
				...
				return t = e, (n = [{
					...
					value: function() {
						...
						if (n) {
							...
							if ("function" == typeof o && (o = o(), this.options.data = o), u(o)) return Y(O(Ze, We({}, this.options, {
								updateData: t
							})), n), this;
