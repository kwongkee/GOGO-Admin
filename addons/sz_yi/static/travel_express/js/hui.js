...
var hui = (function(selector){
	...
	_hui.ajax = function(sets){
		...
		sets.cache = 'cache' in sets ? sets.cache : false;
        sets.contentType = 'contentType' in sets ? sets.contentType : false;
        sets.processData = 'processData' in sets ? sets.processData : false;
