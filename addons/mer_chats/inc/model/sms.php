...
class Sms
{
    ...
    public function send($mobile, $tplid, $data, $replace = true)
    {
        ...
        if ($template['type'] == 'juhe') {
            ...
            //include_once IA_ROOT . '/addons/mer_chats/vendor/dayu/TopSdk.php';
            include_once IA_ROOT . '/addons/mer_chats/vendor/dayu/top/TopClient.php';
            include_once IA_ROOT . '/addons/mer_chats/vendor/dayu/top/ResultSet.php';
            include_once IA_ROOT . '/addons/mer_chats/vendor/dayu/top/TopLogger.php';
            include_once IA_ROOT . '/addons/mer_chats/vendor/dayu/top/RequestCheckUtil.php';
            include_once IA_ROOT . '/addons/mer_chats/vendor/dayu/top/request/AlibabaAliqinFcSmsNumSendRequest.php';
            ...
            include_once A_ROOT . '/addons/mer_chats/vendor/emay/SMSUtil.php';
