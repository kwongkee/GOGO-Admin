...
(3, 3, 'commission', '分销', '1.0', '官方', 1, 'biz', 0, '../addons/ewei_shopv2/static/images/commission.jpg', '', 0, 0),
...
(18, 19, 'groups', '拼团', '1.0', '官方', 1, 'biz', 0, '../addons/ewei_shopv2/static/images/groups.jpg', '', 0, 0),
...
UPDATE  `ims_modules` SET  `version` =  '2.8.7.2',
`author` =  'LTD',
`url` =  'http://www.gd633.com' WHERE  `name` ='ewei_shopv2';
");