...
class DiypageModel extends PluginModel 
{
	...
	public function getPageList($type = 'allpage', $condition = NULL, $page = 0) 
	{
		...
		{
			$c = ' and ((type>1 and type<4) or type=5) ';
		}
		else if ($type == 'plu') 
		{
			$c = ' and type>3 and type<99 and type!=5';
		}
		else if ($type == 'mod') 
		{
			$c = ' and type=99 ';
	...
	public function verify($do, $pagetype) 
	{
		...
		else if ($do == 'edit') 
		{
			...
			else if (($pagetype == 'sys') && ($page['type'] != 2) && ($page['type'] != 3) && ($page['type'] != 5)) 
			{
				$type = $this->getPageType($page['type']);
				$url = webUrl('diypage/page') . '.' . $type['pagetype'] . '.edit&id=' . $id;
				header('location: ' . $url);
	...
	{
		$pagetype = array( 1 => array('name' => '自定义', 'pagetype' => 'diy', 'class' => ''), 2 => array('name' => '商城首页', 'pagetype' => 'sys', 'class' => 'success'), 3 => array('name' => '会员中心', 'pagetype' => 'sys', 'class' => 'primary'), 4 => array('name' => '分销中心', 'pagetype' => 'plu', 'class' => 'warning'), 5 => array('name' => '商品详情页', 'pagetype' => 'sys', 'class' => 'danger'), 6 => array('name' => '积分商城', 'pagetype' => 'plu', 'class' => 'info'), 7 => array('name' => '整点秒杀', 'pagetype' => 'plu', 'class' => 'danger'), 8 => array('name' => '兑换中心', 'pagetype' => 'plu', 'class' => 'success'), 99 => array('name' => '公用模块', 'pagetype' => 'mod', 'class' => '') );
		if (!(empty($type))) 
		{
