<?php
/**
 * [WeEngine System] Copyright (c) 2014 gd333.com
 * WeEngine is NOT a free software, it under the license terms, visited http://www.gd333.com/ for more details.
 */
...
/*  		$_GPC['template'] = mysql_real_escape_string($_GPC['template']);
		...
		$_GPC['template'] = mysql_escape_string($_GPC['template']);
		$_GPC['title'] = mysql_escape_string($_GPC['title']);
		$_GPC['description'] = mysql_escape_string($_GPC['description']);
		$_GPC['source'] = mysql_escape_string($_GPC['source']);
		$_GPC['author'] = mysql_escape_string($_GPC['author']); 
		$data = array(
			'uniacid' => $_W['uniacid'],
