...
class Index_EweiShopV2Page extends WebPage
{
	...
	public function query()
	{
		...
		if(empty($ds)){
		$sql="SELECT `uniacid`,`uid`,`realname`,`mobile`,`createtime`,`nickname`,`avatar` FROM `".tablename('mc_members')."`WHERE uniacid=:uniacid AND `realname` LIKE :keyword or `nickname` LIKE :keyword or `mobile` LIKE :keyword";
