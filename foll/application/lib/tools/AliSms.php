...
require_once Env::get('extend_path') . '/api_sdk/vendor/autoload.php';
...
class AliSms
{
    public function __construct()
    {
        ...
        $access_key_id = config('setting.ACCESS_KEY_ID');
        $access_key_secret = config('setting.ACCESS_KEY_SECRET');
