<?php
	...
	// 添加用户OPENID
	$phone = pdo_get('parking_authorize',array('mobile'=>$Tel),array('id','auth_status','openid','CarNo','name','CertNo'));
	if(empty($phone))
	{
		// 跳转注册
	...
	if($phone['auth_status'] == 1 ) {
		...
		if($res['userState'] == 'NORMAL') {// 已签约状态
			if(empty($phone['auth_status']) || empty($phone['auth_type'])){
				$resd = pdo_update('parking_authorize',['auth_status'=>1,'auth_type'=>'a:1:{s:2:"wx";s:7:"Fwechat";}','deductMode'=>$res['deductMode']], array('id' => $phone['id']));
			}
...
<!--                        <li><a href="#">伦教停车已营运,车主停车时请扫/输码确认,离开时系统智能计/免费,服务热线:4009313038</a></li>-->
    ...
    <ul class="navv">
        ...
        <li class="nav_icon02"><a href="http://shop.gogo198.cn/app/index.php?i=14&c=entry&m=ewei_shopv2&do=mobile&r=parking.parking_management.main"><div></div><p class="nav_p">服务导航</p></a></li>
            ...
            <div class="col-sm-12">
                ...
                <form name="form1" class="form-horizontal" style="text-align: left;">
                    ...
                    <div class="form-group form_border">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="UserName" name="UserName" placeholder="请输入您的真实姓名" value="<?php echo $phone['name']?>" >
                    ...
                    <div class="form-group form_border">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="CertNo" name="CertNo" maxlength="18" placeholder="请输入您的身份证号码" value="<?php echo $phone['CertNo']?>">
